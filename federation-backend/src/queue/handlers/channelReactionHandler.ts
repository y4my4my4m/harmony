...
import { handleChannelReactionFederation } from '../../listeners/ChannelReactionHandler.js';
...
export async function handleChannelReactionJob(data: FederationJobData): Promise<void> {
  ...
  logger.info(`💬⭐ Processing channel reaction job: ${type} for reaction ${reaction_id}`);
