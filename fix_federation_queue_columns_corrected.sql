-- Fix Federation Queue Column Names (CORRECTED)
-- This fixes the "activity_uuid does not exist" error AND uses modern functions

BEGIN;

-- =====================================================
-- FIX: Update handle_outgoing_messages with CORRECT column names AND modern functions
-- =====================================================
...
'FIXED: Uses correct federation_delivery_queue column names AND modern convert_jsonb_to_ap() function (not deprecated convert_unified_content_to_activitypub_html).';
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fixed TWO critical issues:';
    ...
    RAISE NOTICE '🚀 Outgoing DMs should now work with MODERN functions!';
END $$;
