-- Migration 079: Revert to Last Known Working Trigger
-- ISSUE: Messages appear in real-time but not on page reload after recent trigger changes
-- SOLUTION: Revert to the exact working version from schema backup
