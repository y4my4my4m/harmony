-- Fix Federated ID Usage in DM Federation
-- ISSUE: Code is trying to construct URLs when federated_id already contains the complete ActivityPub actor URL
-- SOLUTION: Use federated_id directly for remote users, only construct URLs for local users
