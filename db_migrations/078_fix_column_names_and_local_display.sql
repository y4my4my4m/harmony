-- Migration 078: Fix Column Names for ap_activities Table
-- ISSUE: Using wrong column names (activity_type vs ap_type, actor_profile_id vs actor_id)
-- SOLUTION: Use the correct column names from the actual table schema
...
BEGIN
    ...
    BEGIN
        ...
        LOOP
            ...
            -- Insert into ap_activities table with CORRECT column names
            INSERT INTO ap_activities (
                ap_type,               -- ✅ CORRECT: not "activity_type"
                activity_data,
                actor_id,              -- ✅ CORRECT: not "actor_profile_id"
                object_id
            ) VALUES (
                'Create',
                v_activity,
