...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'EMERGENCY FIX FAILED: Function missing queue calls';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'EMERGENCY FIX FAILED: Posts trigger missing';
    END IF;
    
    RAISE NOTICE '🔥 EMERGENCY FIX SUCCESSFUL!';
    RAISE NOTICE '✅ Function updated with queue_activity_for_federation calls';
    RAISE NOTICE '✅ Posts federation trigger created';
    RAISE NOTICE '🎯 Posts should now federate properly!';
END $$;

-- Log completion
INSERT INTO migration_log (version, description, applied_at) 
VALUES (32, 'EMERGENCY federation fix - function queue calls + posts trigger', NOW())
