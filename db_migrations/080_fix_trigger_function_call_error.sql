-- Migration 080: Fix Trigger Function Call Error
-- ISSUE: handle_messages() tries to call handle_outgoing_messages() but trigger functions can only be called BY triggers
-- FIX: Drop broken triggers and use WHEN condition approach (the professional way)

BEGIN;

-- =================================================================
-- DROP: All broken triggers and functions
-- =================================================================
...
DO $$
BEGIN
    RAISE WARNING '✅ Migration 080: Created handle_messages() dispatcher - keeps existing functions unchanged';
END $$;
