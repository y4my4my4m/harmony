...
For a full production stack (Docker, federation, voice), use [self-hosting guide](./self-hosting.md). For desktop builds, see `npm run tauri:build`.
...
See [self-hosting guide](./self-hosting.md) for details.
