-- Fix notification preferences checks in send_notification function
-- This adds missing notification types and proper master toggle checks
-- 
-- Apply with: psql -d your_database -f 01_fix_notification_preferences.sql
...
COMMENT ON FUNCTION public.send_notification IS 'Send notifications with full preference checking. Supports master toggles, per-type settings, DND, blocks, mutes, and view context suppression.';
