...
-- Fix handle_unified_notification_processing to use extract_message_text()
-- for content_preview instead of passing the raw jsonb content array.
-- This prevents raw JSON from being displayed in notification previews.
