...
--
-- Name: session_meets_aal_requirement(); Type: FUNCTION; Schema: auth; Owner: -
--
...
--
-- Name: user_requires_aal2(); Type: FUNCTION; Schema: auth; Owner: -
--

CREATE FUNCTION auth.user_requires_aal2() RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 
