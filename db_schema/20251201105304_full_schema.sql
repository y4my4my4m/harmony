...
ALTER SCHEMA "pgboss" OWNER TO "supabase_admin";
...
ALTER TYPE "pgboss"."job_state" OWNER TO "supabase_admin";
...
ALTER FUNCTION "pgboss"."create_queue"("queue_name" "text", "options" "json") OWNER TO "supabase_admin";
...
ALTER FUNCTION "pgboss"."delete_queue"("queue_name" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."add_bot_to_server"("p_bot_id" "uuid", "p_server_id" "uuid", "p_installed_by" "uuid", "p_permissions" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
...
ALTER FUNCTION "public"."add_bot_to_server"("p_bot_id" "uuid", "p_server_id" "uuid", "p_installed_by" "uuid", "p_permissions" "jsonb") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."add_existing_posts_to_new_follower_timeline"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    post_record RECORD;
...
ALTER FUNCTION "public"."add_existing_posts_to_new_follower_timeline"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."add_post_emoji_reaction"("p_user_id" "uuid", "p_post_id" "uuid", "p_emoji_id" "uuid" DEFAULT NULL::"uuid", "p_custom_emoji_content" "text" DEFAULT NULL::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."add_post_emoji_reaction"("p_user_id" "uuid", "p_post_id" "uuid", "p_emoji_id" "uuid", "p_custom_emoji_content" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."add_user_prekeys"("p_user_id" "uuid", "p_device_id" "text", "p_prekeys" "jsonb") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_prekey JSONB;
...
ALTER FUNCTION "public"."add_user_prekeys"("p_user_id" "uuid", "p_device_id" "text", "p_prekeys" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."add_user_to_conversation"("conversation_uuid" "uuid", "user_uuid" "uuid", "user_role" "text" DEFAULT 'member'::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."add_user_to_conversation"("conversation_uuid" "uuid", "user_uuid" "uuid", "user_role" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."backfill_timeline_entries"() RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."backfill_timeline_entries"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."backfill_timeline_on_follow"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    post_record RECORD;
...
ALTER FUNCTION "public"."backfill_timeline_on_follow"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."build_emoji_reaction_activity"("p_interaction_id" "uuid", "p_user_id" "uuid", "p_post_id" "uuid", "p_emoji_id" "uuid" DEFAULT NULL::"uuid", "p_custom_emoji_content" "text" DEFAULT NULL::"text", "p_is_undo" boolean DEFAULT false) RETURNS "jsonb"
...
ALTER FUNCTION "public"."build_emoji_reaction_activity"("p_interaction_id" "uuid", "p_user_id" "uuid", "p_post_id" "uuid", "p_emoji_id" "uuid", "p_custom_emoji_content" "text", "p_is_undo" boolean) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."build_harmony_embed"("p_url" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."build_post_create_activity"("p_post_id" "uuid", "p_author_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
    v_post RECORD;
...
ALTER FUNCTION "public"."build_post_create_activity"("p_post_id" "uuid", "p_author_id" "uuid") OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."build_post_create_activity"("p_post_id" "uuid", "p_author_id" "uuid") IS 'Builds an ActivityPub Create activity for a post. Uses convert_content_to_html for NULL-safe HTML generation of mentions, emojis, and hashtags.';



CREATE OR REPLACE FUNCTION "public"."can_manage_group_icon"("conversation_uuid" "uuid", "user_profile_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."can_manage_group_icon"("conversation_uuid" "uuid", "user_profile_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."cascade_delete_reblogs"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."cascade_delete_reblogs"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."check_bot_permission"("p_bot_id" "uuid", "p_server_id" "uuid", "p_permission" "text") RETURNS boolean
    LANGUAGE "plpgsql" STABLE
    AS $_$
DECLARE
...
ALTER FUNCTION "public"."check_bot_permission"("p_bot_id" "uuid", "p_server_id" "uuid", "p_permission" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."check_emoji_reaction_limit"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."check_emoji_reaction_limit"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."check_encryption_policy"("p_server_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."check_message_emoji_reaction_limit"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_emoji_count integer;
...
ALTER FUNCTION "public"."check_message_emoji_reaction_limit"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."check_timeline_health"("p_user_id" "uuid") RETURNS TABLE("timeline_type" "text", "total_entries" integer, "recent_entries" integer, "following_count" integer, "recommendations" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."check_timeline_health"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."claim_session_share"("p_share_id" "uuid", "p_user_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."classify_activitypub_activity"("p_activity_data" "jsonb", "p_instance_domain" "text") RETURNS TABLE("is_direct_message" boolean, "confidence" numeric)
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
  v_object JSONB;
...
ALTER FUNCTION "public"."classify_activitypub_activity"("p_activity_data" "jsonb", "p_instance_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."cleanup_expired_key_requests"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_expired_key_requests"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."cleanup_expired_voice_calls"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."cleanup_expired_voice_calls"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."cleanup_old_federation_deliveries"() RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_old_federation_deliveries"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."cleanup_old_notifications"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."cleanup_old_trending_data"() RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_old_trending_data"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."cleanup_stale_push_subscriptions"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    deleted_count integer;
...
ALTER FUNCTION "public"."cleanup_stale_push_subscriptions"() OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."cleanup_stale_push_subscriptions"() IS 'Removes push subscriptions that have repeatedly failed. Should be run periodically via cron.';



CREATE OR REPLACE FUNCTION "public"."cleanup_stale_user_sessions"() RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    deleted_count integer;
...
ALTER FUNCTION "public"."cleanup_stale_user_sessions"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."cleanup_stale_view_contexts"() RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    deleted_count INTEGER;
...
ALTER FUNCTION "public"."cleanup_stale_view_contexts"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."convert_ap_to_jsonb"("html_content" "text", "tags" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."convert_content_to_html"("p_content" "jsonb", "p_instance_domain" "text") RETURNS "text"
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
    v_html text;
...
ALTER FUNCTION "public"."convert_content_to_html"("p_content" "jsonb", "p_instance_domain" "text") OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."convert_content_to_html"("p_content" "jsonb", "p_instance_domain" "text") IS 'Converts post content JSONB array to HTML string for ActivityPub federation. Properly handles NULL values in mentions, emojis, and hashtags to prevent data loss.';
...
ALTER FUNCTION "public"."convert_jsonb_to_ap"("content" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."count_unused_recovery_codes"("p_user_id" "uuid") RETURNS integer
...
ALTER FUNCTION "public"."count_unused_recovery_codes"("p_user_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."create_activitypub_note_activity"("post_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_activitypub_note_activity"("post_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."create_comprehensive_timeline_entries"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    follower_record RECORD;
...
ALTER FUNCTION "public"."create_comprehensive_timeline_entries"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."create_default_notification_preferences"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."create_default_server_structure"("p_server_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_default_server_structure"("p_server_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."create_federated_emoji"("p_name" "text", "p_url" "text", "p_uploader" "uuid", "p_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."create_group_conversation"("creator_user_id" "uuid", "participant_user_ids" "uuid"[], "conversation_name" "text" DEFAULT NULL::"text", "is_private" boolean DEFAULT true) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_group_conversation"("creator_user_id" "uuid", "participant_user_ids" "uuid"[], "conversation_name" "text", "is_private" boolean) OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."create_group_conversation"("creator_user_id" "uuid", "conversation_name" "text" DEFAULT NULL::"text", "participant_ids" "uuid"[] DEFAULT '{}'::"uuid"[], "initial_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_group_conversation"("creator_user_id" "uuid", "conversation_name" "text", "participant_ids" "uuid"[], "initial_metadata" "jsonb") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."create_notification_preferences"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."create_notification_structured"("p_user_id" "uuid", "p_type" character varying, "p_data" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_notification_structured"("p_user_id" "uuid", "p_type" character varying, "p_data" "jsonb") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."create_notification_with_spam_prevention"("p_user_id" "uuid", "p_type" "text", "p_source_user_id" "uuid", "p_title" "text", "p_message" "text", "p_data" "jsonb", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."create_or_get_direct_conversation"("user1_uuid" "uuid", "user2_uuid" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_or_get_direct_conversation"("user1_uuid" "uuid", "user2_uuid" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."create_or_get_multi_conversation"("participant_ids" "uuid"[], "conversation_type" "text" DEFAULT 'direct'::"text", "conversation_name" "text" DEFAULT NULL::"text", "created_by_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_or_get_multi_conversation"("participant_ids" "uuid"[], "conversation_type" "text", "conversation_name" "text", "created_by_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."create_system_message"("p_channel_id" "uuid", "p_message_type" "text", "p_data" "jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  message_id UUID;
...
ALTER FUNCTION "public"."create_system_message"("p_channel_id" "uuid", "p_message_type" "text", "p_data" "jsonb") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."delete_push_subscription_by_endpoint"("p_endpoint" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."delete_server_with_cleanup"("p_server_id" "uuid", "p_owner_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    -- Verify ownership
...
ALTER FUNCTION "public"."delete_server_with_cleanup"("p_server_id" "uuid", "p_owner_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."detect_embed_provider"("p_url" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."detect_message_features"("content_parts" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
  part jsonb;
...
ALTER FUNCTION "public"."detect_message_features"("content_parts" "jsonb") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."determine_message_federation_type"("p_message_id" "uuid") RETURNS "text"
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
  v_message_type TEXT;
...
ALTER FUNCTION "public"."determine_message_federation_type"("p_message_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."disable_federation_triggers"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."disable_federation_triggers"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."enable_conversation_encryption"("p_conversation_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_status JSONB;
...
ALTER FUNCTION "public"."enable_conversation_encryption"("p_conversation_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."enable_federation_triggers"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."enable_federation_triggers"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."end_user_session"("p_session_token" "text") RETURNS "void"
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
    UPDATE public.user_sessions
...
ALTER FUNCTION "public"."end_user_session"("p_session_token" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."extract_activitypub_emoji_tags"("content" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
    content_part JSONB;
...
ALTER FUNCTION "public"."extract_activitypub_emoji_tags"("content" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_activitypub_hashtag_tags"("content" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
    content_part JSONB;
...
ALTER FUNCTION "public"."extract_activitypub_hashtag_tags"("content" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_activitypub_tags"("content" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
    mention_tags JSONB;
...
ALTER FUNCTION "public"."extract_activitypub_tags"("content" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_custom_emoji_for_federation"("content_text" "text") RETURNS TABLE("emoji_id" "uuid", "emoji_name" "text", "emoji_url" "text")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."extract_custom_emoji_for_federation"("content_text" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_hashtags_from_content"("p_content" "jsonb") RETURNS "text"[]
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
...
ALTER FUNCTION "public"."extract_hashtags_from_content"("p_content" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_mentions"("content" "jsonb") RETURNS "text"[]
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    mentions TEXT[] := '{}';
...
ALTER FUNCTION "public"."extract_mentions"("content" "jsonb") OWNER TO "postgres";
...
ALTER FUNCTION "public"."extract_message_text"("content_parts" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."extract_url_host"("p_url" "text") RETURNS "text"
...
ALTER FUNCTION "public"."extract_url_host"("p_url" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."fetch_generic_preview"("p_url" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."fetch_generic_preview"("p_url" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."fetch_link_preview"("p_url" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."fetch_oembed_preview"("p_url" "text", "p_endpoint" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
declare
  resp net.http_response;
...
ALTER FUNCTION "public"."fetch_oembed_preview"("p_url" "text", "p_endpoint" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."fetch_remote_link_preview"("p_backend_base_url" "text", "p_url" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."fetch_remote_link_preview"("p_backend_base_url" "text", "p_url" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_activitypub_conversation_root"("post_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_batch_message_reactions"("message_ids" "uuid"[]) RETURNS TABLE("message_id" "uuid", "emoji_id" "uuid", "emoji_name" character varying, "emoji_url" character varying, "custom_emoji_content" "text", "reaction_count" bigint, "users" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_batch_message_reactions"("message_ids" "uuid"[]) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_batch_post_emoji_reactions"("p_post_ids" "uuid"[], "p_user_limit" integer) OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."get_batch_post_emoji_reactions"("p_post_ids" "uuid"[], "p_user_limit" integer) IS 'Batch get emoji reactions for multiple posts. Used for timeline loading. FIXED: Uses profile ID (not auth ID) for current_user_reacted check.';



CREATE OR REPLACE FUNCTION "public"."get_batch_post_reactions"("post_ids" "uuid"[]) RETURNS TABLE("post_id" "uuid", "emoji_id" "uuid", "emoji_name" character varying, "emoji_url" character varying, "reaction_count" bigint, "users" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_batch_post_reactions"("post_ids" "uuid"[]) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_channel_server_id"("channel_uuid" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
  server_uuid uuid;
...
ALTER FUNCTION "public"."get_channel_server_id"("channel_uuid" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_conversation_context"("in_post_id" "uuid", "in_user_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_conversation_encryption_status"("p_conversation_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_conversation_participants"("conversation_uuid" "uuid") RETURNS TABLE("user_id" "uuid", "role" "text", "joined_at" timestamp with time zone, "is_muted" boolean, "last_read_at" timestamp with time zone)
    LANGUAGE "sql" STABLE
    AS $$
  SELECT 
    cp.user_id,
...
ALTER FUNCTION "public"."get_conversation_participants"("conversation_uuid" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_conversation_thread"("p_conversation_id" "text", "p_user_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_current_profile_id"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_current_user_profile_id"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."get_default_channel"("p_server_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    channel_id UUID;
...
ALTER FUNCTION "public"."get_default_channel"("p_server_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_emoji_metadata_bulk"("server_ids" "uuid"[]) RETURNS TABLE("server_id" "uuid", "last_modified" timestamp with time zone, "emoji_count" integer)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_emoji_metadata_bulk"("server_ids" "uuid"[]) OWNER TO "postgres";
...
ALTER TABLE "public"."encryption_sessions" OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_local_device_id" "text" DEFAULT 'default'::"text", "p_remote_device_id" "text" DEFAULT 'default'::"text") RETURNS "public"."encryption_sessions"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_local_device_id" "text", "p_remote_device_id" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_enhanced_timeline_posts"("p_user_id" "uuid", "p_timeline_type" "text", "p_limit" integer, "p_max_id" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_featured_posts_hybrid"("p_author_id" "uuid", "p_limit" integer) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_federated_timeline"("p_user_id" "uuid", "p_limit" integer, "p_max_id" "text") OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."get_federated_timeline"("p_user_id" "uuid", "p_limit" integer, "p_max_id" "text") IS 'Returns all known remote public posts for the federated timeline. 
...
CREATE OR REPLACE FUNCTION "public"."get_federation_config"() RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
    config jsonb;
...
ALTER FUNCTION "public"."get_federation_config"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_follow_status"("current_user_id" "uuid", "target_user_id" "uuid") RETURNS TABLE("is_following" boolean, "is_followed_by" boolean, "follow_status" "text", "followed_by_status" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_follow_status"("current_user_id" "uuid", "target_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_instance_config"("p_key" "text" DEFAULT NULL::"text") RETURNS TABLE("config_key" "text", "config_value" "jsonb", "description" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_instance_config"("p_key" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_instance_domain"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_message_reactions"("message_id" "uuid") RETURNS TABLE("count" bigint, "emoji" "jsonb", "reactions" "jsonb", "message_id_of_reactions" "uuid")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_message_reactions"("message_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_or_create_conversation"("user1_uuid" "uuid", "user2_uuid" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_or_create_dm_conversation"("p_user1_id" "uuid", "p_user2_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_conversation_id UUID;
...
ALTER FUNCTION "public"."get_or_create_dm_conversation"("p_user1_id" "uuid", "p_user2_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_pending_reports_count"() RETURNS integer
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $$
    SELECT COUNT(*)::integer
    FROM public.reports
...
ALTER FUNCTION "public"."get_pending_reports_count"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_post_emoji_reactions"("p_post_id" "uuid", "p_user_limit" integer) OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."get_post_emoji_reactions"("p_post_id" "uuid", "p_user_limit" integer) IS 'Get emoji reactions for a post. Returns grouped reactions with user data for tooltips. FIXED: Uses profile ID (not auth ID) for current_user_reacted check.';
...
ALTER FUNCTION "public"."get_post_with_context"("p_post_id" "uuid", "p_user_id" "uuid", "p_context_type" "text", "p_highlight_reply" "uuid", "p_max_depth" integer, "p_include_interactions" boolean) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_public_federation_settings"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_public_federation_settings"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_public_instance_info"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    instance_name text;
...
ALTER FUNCTION "public"."get_public_instance_info"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_recent_admin_activity"("p_limit" integer DEFAULT 20) RETURNS TABLE("id" "uuid", "admin_username" "text", "action_type" "text", "target_type" "text", "target_id" "text", "action_details" "jsonb", "created_at" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_reports_with_details"("p_status" "text", "p_limit" integer, "p_offset" integer) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_server_encryption_policy"("p_server_id" "uuid") RETURNS TABLE("encryption_mode" "text", "allow_federation" boolean, "require_verified_devices" boolean, "force_key_setup" boolean, "encrypt_attachments" boolean, "is_encrypted" boolean)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_server_encryption_policy"("p_server_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_server_members_by_instance"("p_server_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_system_stats"() RETURNS "jsonb"
    LANGUAGE "sql" STABLE
    AS $$
  SELECT jsonb_build_object(
...
ALTER FUNCTION "public"."get_system_stats"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_timeline"("p_user_id" "uuid", "p_limit" integer DEFAULT 50, "p_before" timestamp without time zone DEFAULT "now"()) RETURNS SETOF "public"."posts"
    LANGUAGE "sql" STABLE
    AS $$
  SELECT p.*
  FROM posts p
...
ALTER FUNCTION "public"."get_timeline"("p_user_id" "uuid", "p_limit" integer, "p_before" timestamp without time zone) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_trending_hashtags"("p_days" integer DEFAULT 7, "p_limit" integer DEFAULT 20) RETURNS TABLE("tag" "text", "uses_count" bigint, "unique_users" bigint)
    LANGUAGE "sql" STABLE
    AS $$
  SELECT 
    h.tag,
...
ALTER FUNCTION "public"."get_trending_hashtags"("p_days" integer, "p_limit" integer) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_unclaimed_session_shares"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_unread_notification_count"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER TABLE "public"."prekeys" OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_unused_prekey"("p_user_id" "uuid", "p_device_id" "text" DEFAULT 'default'::"text") RETURNS "public"."prekeys"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_user_bookmarks"("p_user_id" "uuid", "p_limit" integer, "p_cursor" timestamp with time zone) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_user_conversations_with_participants"("user_uuid" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_user_featured_posts"("p_author_id" "uuid", "p_limit" integer) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_user_handle"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_user_id_from_username"("username_param" "text") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    user_id UUID;
...
ALTER FUNCTION "public"."get_user_id_from_username"("username_param" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_notifications"("p_user_id" "uuid", "p_limit" integer, "p_offset" integer, "p_unread_only" boolean, "p_notification_types" character varying[]) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_user_prekey_bundle"("p_user_id" "uuid", "p_device_id" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."get_user_private_key"("p_user_id" "uuid") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_user_private_key"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."get_user_push_subscriptions"("p_user_id" "uuid") OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."get_user_push_subscriptions"("p_user_id" "uuid") IS 'Gets all active push subscriptions for a user along with their notification preferences';



CREATE OR REPLACE FUNCTION "public"."get_users_needing_prekeys"("p_threshold" integer DEFAULT 10) RETURNS TABLE("user_id" "uuid", "device_id" "text", "unused_prekey_count" bigint)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_users_needing_prekeys"("p_threshold" integer) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."handle_activitypub_activity_processing"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."handle_activitypub_activity_processing"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_incoming_messages"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_local_post_mention_notifications"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_message_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_outgoing_messages"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_post_federation"() OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."handle_post_federation"() IS 'Handles automatic federation of new local posts. Queues Create activities to federation_delivery_queue with sender_id for request signing.';
...
ALTER FUNCTION "public"."handle_post_interaction_federation"() OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."handle_post_interaction_federation"() IS 'Handles automatic federation of emoji reactions. Triggers on post_interactions INSERT/DELETE for emoji_reaction type. Includes sender_id for request signing.';
...
ALTER FUNCTION "public"."handle_post_mention_notifications"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_post_reactions_federation"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."handle_post_soft_delete"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."handle_post_soft_delete"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."handle_profile_update_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."handle_profile_update_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_reactions_federation"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."handle_remote_user_suspension"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."handle_remote_user_suspension"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."handle_unified_interaction_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    user_federation_enabled boolean;
...
ALTER FUNCTION "public"."handle_unified_interaction_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."handle_unified_notification_processing"() OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."handle_unified_notification_processing"() IS 'Handles notifications for follows (with full profile data), reactions, and ActivityPub emoji reactions. 
...
ALTER FUNCTION "public"."handle_unified_profile_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."has_active_session"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."import_remote_emoji"("p_remote_emoji_id" "uuid", "p_new_name" "text", "p_server_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."increment_session_message_count"("p_session_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    UPDATE public.encryption_sessions
...
ALTER FUNCTION "public"."increment_session_message_count"("p_session_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."increment_unread_mentions"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."index_message"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."index_message"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."initialize_user_encryption"("p_user_id" "uuid", "p_identity_public_key" "text", "p_identity_private_key_encrypted" "text", "p_device_id" "text" DEFAULT 'default'::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_key_pair_id UUID;
...
ALTER FUNCTION "public"."initialize_user_encryption"("p_user_id" "uuid", "p_identity_public_key" "text", "p_identity_private_key_encrypted" "text", "p_device_id" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."insert_ap_activity_safe"("p_ap_id" "text", "p_ap_type" "text", "p_actor_ap_id" "text", "p_activity_data" "jsonb", "p_origin_domain" "text" DEFAULT NULL::"text", "p_to_addresses" "text"[] DEFAULT '{}'::"text"[], "p_cc_addresses" "text"[] DEFAULT '{}'::"text"[], "p_is_local" boolean DEFAULT false) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."insert_ap_activity_safe"("p_ap_id" "text", "p_ap_type" "text", "p_actor_ap_id" "text", "p_activity_data" "jsonb", "p_origin_domain" "text", "p_to_addresses" "text"[], "p_cc_addresses" "text"[], "p_is_local" boolean) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_activitypub_direct_message"("object_data" "jsonb", "instance_domain" "text") RETURNS boolean
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
    v_to JSONB;
...
ALTER FUNCTION "public"."is_activitypub_direct_message"("object_data" "jsonb", "instance_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_author_suspended"("p_author_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $$
  -- FIXED: Use outer COALESCE to handle missing profiles
  -- Returns FALSE if profile doesn't exist (federated users) or is_suspended is NULL
  SELECT COALESCE(
    (SELECT COALESCE(is_suspended, false) FROM public.profiles WHERE id = p_author_id LIMIT 1),
    false  -- Return FALSE if no profile found (federated content)
  )
$$;


ALTER FUNCTION "public"."is_author_suspended"("p_author_id" "uuid") OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."is_author_suspended"("p_author_id" "uuid") IS 'Returns true if the post author is suspended. Returns FALSE for missing profiles (federated content). Used by RLS policies.';



CREATE OR REPLACE FUNCTION "public"."is_emoji_reaction_activity"("p_activity" "jsonb") RETURNS boolean
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
BEGIN
...
ALTER FUNCTION "public"."is_emoji_reaction_activity"("p_activity" "jsonb") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_federation_enabled_for_user"("user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
...
ALTER FUNCTION "public"."is_federation_enabled_for_user"("user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_local_user"("p_user_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  SELECT is_local
  FROM profiles
...
ALTER FUNCTION "public"."is_local_user"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_user_in_conversation"("user_uuid" "uuid", "conversation_uuid" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  SELECT EXISTS(
    SELECT 1 FROM conversation_participants 
...
ALTER FUNCTION "public"."is_user_in_conversation"("user_uuid" "uuid", "conversation_uuid" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."is_user_suspended"("p_user_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."is_user_suspended"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."is_user_viewing_context"("p_user_id" "uuid", "p_server_id" "uuid" DEFAULT NULL::"uuid", "p_channel_id" "uuid" DEFAULT NULL::"uuid", "p_conversation_id" "uuid" DEFAULT NULL::"uuid") RETURNS boolean
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
...
ALTER FUNCTION "public"."is_user_viewing_context"("p_user_id" "uuid", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."is_user_viewing_push_context"("p_user_id" "uuid", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."log_activity_processing_event"("p_activity_id" "uuid", "p_ap_id" "text", "p_ap_type" "text", "p_status" "text", "p_error_message" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."log_activity_processing_event"("p_activity_id" "uuid", "p_ap_id" "text", "p_ap_type" "text", "p_status" "text", "p_error_message" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."log_admin_action"("p_admin_id" "uuid", "p_action_type" "text", "p_target_type" "text" DEFAULT NULL::"text", "p_target_id" "text" DEFAULT NULL::"text", "p_action_details" "jsonb" DEFAULT NULL::"jsonb", "p_ip_address" "inet" DEFAULT NULL::"inet", "p_user_agent" "text" DEFAULT NULL::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    log_id UUID;
...
ALTER FUNCTION "public"."log_admin_action"("p_admin_id" "uuid", "p_action_type" "text", "p_target_type" "text", "p_target_id" "text", "p_action_details" "jsonb", "p_ip_address" "inet", "p_user_agent" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."log_key_generation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."make_absolute_url"("base_url" "text", "candidate" "text") RETURNS "text"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
declare
  origin text;
...
ALTER FUNCTION "public"."make_absolute_url"("base_url" "text", "candidate" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."mark_all_notifications_read"("p_user_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."mark_instance_reachable"("p_domain" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."mark_instance_reachable"("p_domain" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."mark_instance_unreachable"("p_domain" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    UPDATE federated_instances 
...
ALTER FUNCTION "public"."mark_instance_unreachable"("p_domain" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."mark_notification_read"("notification_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."mark_notifications_read"("p_user_id" "uuid", "p_notification_ids" "uuid"[]) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."moderate_instance"("p_admin_id" "uuid", "p_domain" "text", "p_action" "text", "p_reason" "text" DEFAULT NULL::"text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."moderate_instance"("p_admin_id" "uuid", "p_domain" "text", "p_action" "text", "p_reason" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."moderate_user"("p_admin_id" "uuid", "p_target_user_id" "uuid", "p_action" "text", "p_reason" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."normalize_embed_url"("p_url" "text") RETURNS "text"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
declare
...
ALTER FUNCTION "public"."normalize_embed_url"("p_url" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."normalize_hashtag"("tag" "text") RETURNS "text"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
BEGIN
...
ALTER FUNCTION "public"."normalize_hashtag"("tag" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."notify_federation_event"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."notify_federation_event"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."notify_new_activity"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."pause_activitypub_cron_jobs"() RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."pause_activitypub_cron_jobs"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_accept_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'extensions', 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."process_accept_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."process_activitypub_note"("note_data" "jsonb", "actor_profile_id" "uuid" DEFAULT NULL::"uuid", "instance_domain" "text" DEFAULT NULL::"text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $_$
DECLARE
    v_conversation_id uuid;
...
ALTER FUNCTION "public"."process_activitypub_note"("note_data" "jsonb", "actor_profile_id" "uuid", "instance_domain" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."process_activitypub_public_post"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."process_announce_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object_id TEXT;
...
ALTER FUNCTION "public"."process_announce_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_ap_activity_on_update"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_instance_domain TEXT;
...
ALTER FUNCTION "public"."process_ap_activity_on_update"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_create_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object JSONB;
...
ALTER FUNCTION "public"."process_create_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_delete_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object_id TEXT;
...
ALTER FUNCTION "public"."process_delete_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_follow_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."process_follow_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_incoming_emoji_reaction"("p_activity_id" "text", "p_activity" "jsonb", "p_actor_uri" "text", "p_actor_domain" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $_$
DECLARE
    v_actor_profile RECORD;
...
ALTER FUNCTION "public"."process_incoming_emoji_reaction"("p_activity_id" "text", "p_activity" "jsonb", "p_actor_uri" "text", "p_actor_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."process_incoming_private_message"("p_activity_id" "uuid", "p_activity_data" "jsonb", "p_actor_profile_id" "uuid", "p_instance_domain" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_object JSONB;
...
ALTER FUNCTION "public"."process_incoming_private_message"("p_activity_id" "uuid", "p_activity_data" "jsonb", "p_actor_profile_id" "uuid", "p_instance_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."process_like_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object_id TEXT;
...
ALTER FUNCTION "public"."process_like_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_local_link_previews"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."process_local_link_previews"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_message_link_previews"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
declare
...
ALTER FUNCTION "public"."process_message_link_previews"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_post_hashtags"("p_post_id" "uuid", "p_content" "jsonb") RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."process_post_hashtags"("p_post_id" "uuid", "p_content" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."process_reject_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object JSONB;
...
ALTER FUNCTION "public"."process_reject_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."process_undo_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_object JSONB;
...
ALTER FUNCTION "public"."process_undo_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."process_update_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."queue_activity_for_federation"("p_activity_id" "uuid", "p_target_domains" "text"[], "p_priority" integer DEFAULT 5, "p_immediate" boolean DEFAULT false) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."queue_activity_for_federation"("p_activity_id" "uuid", "p_target_domains" "text"[], "p_priority" integer, "p_immediate" boolean) OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."queue_activity_for_federation"("p_activity_id" "uuid", "p_target_domains" "text"[], "p_priority" integer, "p_immediate" boolean) IS 'Queues an ActivityPub activity for federation delivery to specified domains.
...
CREATE OR REPLACE FUNCTION "public"."queue_federation_job"("p_job_name" "text", "p_job_data" "jsonb", "p_priority" integer DEFAULT 5, "p_retry_limit" integer DEFAULT 5, "p_expire_in_seconds" integer DEFAULT 3600) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_job_id uuid;
...
ALTER FUNCTION "public"."queue_federation_job"("p_job_name" "text", "p_job_data" "jsonb", "p_priority" integer, "p_retry_limit" integer, "p_expire_in_seconds" integer) OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."queue_federation_job"("p_job_name" "text", "p_job_data" "jsonb", "p_priority" integer, "p_retry_limit" integer, "p_expire_in_seconds" integer) IS 'Queue a federation job for processing by the federation-backend.
...
ALTER FUNCTION "public"."record_emoji_usage"("p_emoji_id" "uuid", "p_user_id" "uuid", "p_server_id" "uuid", "p_context_type" "text", "p_context_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."record_push_failure"("p_subscription_id" "uuid", "p_reason" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."record_push_success"("p_subscription_id" "uuid") OWNER TO "supabase_admin";
...
ALTER TABLE "public"."recovery_key_metadata" OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."register_recovery_key"("p_user_id" "uuid", "p_verification_code" "text", "p_word_count" integer) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."remove_group_icon"("conversation_uuid" "uuid", "user_profile_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."remove_message_from_index"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."remove_post_emoji_reaction"("p_user_id" "uuid", "p_post_id" "uuid", "p_emoji_id" "uuid", "p_custom_emoji_content" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."remove_timeline_on_unfollow"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."remove_timeline_on_unfollow"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."reset_user_encryption"("p_user_id" "uuid", "p_device_id" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."resolve_activitypub_emoji"("p_emoji_tag" "jsonb", "p_content" "text", "p_actor_domain" "text") RETURNS TABLE("emoji_id" "uuid", "custom_emoji_content" "text")
    LANGUAGE "plpgsql"
    AS $_$
DECLARE
    v_emoji_name text;
...
ALTER FUNCTION "public"."resolve_activitypub_emoji"("p_emoji_tag" "jsonb", "p_content" "text", "p_actor_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."resume_activitypub_cron_jobs"() RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    result TEXT := '';
...
ALTER FUNCTION "public"."resume_activitypub_cron_jobs"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."rotate_prekeys"("p_user_id" "uuid", "p_device_id" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."route_channel_message"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_server_id UUID;
...
ALTER FUNCTION "public"."route_channel_message"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."route_server_leave"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_server RECORD;
...
ALTER FUNCTION "public"."route_server_leave"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."route_server_membership"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_server RECORD;
...
ALTER FUNCTION "public"."route_server_membership"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."run_trending_maintenance"() RETURNS "json"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    result JSON;
...
ALTER FUNCTION "public"."run_trending_maintenance"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."save_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_session_state" "text", "p_local_device_id" "text" DEFAULT 'default'::"text", "p_remote_device_id" "text" DEFAULT 'default'::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_session_id UUID;
...
ALTER FUNCTION "public"."save_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_session_state" "text", "p_local_device_id" "text", "p_remote_device_id" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."save_recovery_codes"("p_user_id" "uuid", "p_codes" "text"[]) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."search_federated_users"("p_query" "text", "p_limit" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."search_messages"("p_query" "text", "p_channel_id" "uuid", "p_channel_ids" "uuid"[], "p_user_id" "uuid", "p_conversation_id" "uuid", "p_server_id" "uuid", "p_has_media" boolean, "p_has_url" boolean, "p_from_date" timestamp with time zone, "p_to_date" timestamp with time zone, "p_limit" integer, "p_offset" integer) OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."search_users"("p_query" "text", "p_limit" integer DEFAULT 20, "p_local_only" boolean DEFAULT false) RETURNS TABLE("id" "uuid", "username" "text", "domain" "text", "display_name" "text", "avatar" "text", "is_local" boolean)
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."search_users"("p_query" "text", "p_limit" integer, "p_local_only" boolean) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."send_accept_activity_for_follow"("follow_activity_id" "uuid", "local_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'extensions', 'public', 'pg_temp'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."send_accept_activity_for_follow"("follow_activity_id" "uuid", "local_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."send_notification"("notification_type" character varying, "to_user_ids" "uuid"[], "notification_data" "jsonb", "server_id" "uuid", "channel_id" "uuid", "conversation_id" "uuid", "from_user_id" "uuid", "priority" character varying) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."send_notification_to_followers"("notification_type" character varying, "target_user_id" "uuid", "notification_data" "jsonb" DEFAULT '{}'::"jsonb", "from_user_id" "uuid" DEFAULT NULL::"uuid", "priority" character varying DEFAULT 'normal'::character varying) RETURNS "uuid"[]
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    follower_ids uuid[];
...
ALTER FUNCTION "public"."send_notification_to_followers"("notification_type" character varying, "target_user_id" "uuid", "notification_data" "jsonb", "from_user_id" "uuid", "priority" character varying) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."send_notification_to_server_members"("notification_type" character varying, "target_server_id" "uuid", "notification_data" "jsonb", "channel_id" "uuid", "from_user_id" "uuid", "exclude_user_ids" "uuid"[], "priority" character varying) OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."send_notification_to_user"("notification_type" character varying, "to_user_id" "uuid", "notification_data" "jsonb", "server_id" "uuid", "channel_id" "uuid", "conversation_id" "uuid", "from_user_id" "uuid", "priority" character varying) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."server_has_remote_members"("p_server_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  SELECT EXISTS(
    SELECT 1 
...
ALTER FUNCTION "public"."server_has_remote_members"("p_server_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."set_instance_config"("p_admin_id" "uuid", "p_key" "text", "p_value" "jsonb", "p_description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_member_instance"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_member_instance"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."should_create_notification"("p_user_id" "uuid", "p_type" character varying, "p_server_id" "uuid" DEFAULT NULL::"uuid", "p_channel_id" "uuid" DEFAULT NULL::"uuid", "p_conversation_id" "uuid" DEFAULT NULL::"uuid") RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."should_create_notification"("p_user_id" "uuid", "p_type" character varying, "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."strip_dm_mentions"("content" "jsonb", "local_instance_domain" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
    result jsonb := '[]'::jsonb;
...
ALTER FUNCTION "public"."strip_dm_mentions"("content" "jsonb", "local_instance_domain" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."strip_mentions_from_dm_content"("content" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
DECLARE
...
ALTER FUNCTION "public"."strip_mentions_from_dm_content"("content" "jsonb") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."sync_view_context_from_presence"("p_view_type" "text", "p_server_id" "uuid" DEFAULT NULL::"uuid", "p_channel_id" "uuid" DEFAULT NULL::"uuid", "p_conversation_id" "uuid" DEFAULT NULL::"uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."sync_view_context_from_presence"("p_view_type" "text", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."trigger_create_default_server_structure"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_create_default_server_structure"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."trigger_extract_post_hashtags"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_extract_post_hashtags"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."trigger_queue_block_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
ALTER FUNCTION "public"."trigger_queue_block_federation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_dm_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_queue_dm_federation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_follow_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
ALTER FUNCTION "public"."trigger_queue_follow_federation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_interaction_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
ALTER FUNCTION "public"."trigger_queue_interaction_federation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_message_reaction_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
ALTER FUNCTION "public"."trigger_queue_message_reaction_federation"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_post_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    ...
    -- For UPDATE: only queue for MEANINGFUL changes
    IF TG_OP = 'UPDATE' THEN
...
ALTER FUNCTION "public"."trigger_queue_post_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."trigger_queue_profile_federation"() OWNER TO "supabase_admin";


COMMENT ON FUNCTION "public"."trigger_queue_profile_federation"() IS 'Queue profile updates for federation via pg-boss. Requires pg-boss for follower enumeration. Safe - does not break on missing tables.';
...
ALTER FUNCTION "public"."trigger_queue_push_notification"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."trigger_queue_report_federation"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    NEW.federation_status := 'queued';
...
ALTER FUNCTION "public"."trigger_queue_report_federation"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_bot_timestamp"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_encryption_timestamp"() OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."update_follow_counters"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_follow_counters"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_group_icon"("conversation_uuid" "uuid", "user_profile_id" "uuid", "icon_path" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_group_name"("conversation_uuid" "uuid", "user_profile_id" "uuid", "new_name" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_megolm_backup_timestamp"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_message_embeds"("p_message_id" "uuid", "p_embeds" "jsonb") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_post_counters"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_post_reaction_counts"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_post_reblog_count"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."update_post_reply_count"() OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."update_push_subscription_timestamp"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = now();
...
ALTER FUNCTION "public"."update_push_subscription_timestamp"() OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."upsert_ap_activity"("p_ap_id" "text", "p_ap_type" "text", "p_actor_ap_id" "text", "p_activity_data" "jsonb", "p_origin_domain" "text", "p_to_addresses" "text"[], "p_cc_addresses" "text"[], "p_bto_addresses" "text"[], "p_bcc_addresses" "text"[], "p_is_local" boolean) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."upsert_hashtag"("p_tag" "text") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_hashtag_id uuid;
...
ALTER FUNCTION "public"."upsert_hashtag"("p_tag" "text") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."upsert_remote_emoji"("p_shortcode" "text", "p_origin_domain" "text", "p_full_code" "text", "p_url" "text", "p_static_url" "text" DEFAULT NULL::"text", "p_category" "text" DEFAULT NULL::"text", "p_is_animated" boolean DEFAULT false) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_id uuid;
...
ALTER FUNCTION "public"."upsert_remote_emoji"("p_shortcode" "text", "p_origin_domain" "text", "p_full_code" "text", "p_url" "text", "p_static_url" "text", "p_category" "text", "p_is_animated" boolean) OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."upsert_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_platform" "text" DEFAULT 'web'::"text", "p_form_factor" "text" DEFAULT 'desktop'::"text", "p_is_pwa" boolean DEFAULT false, "p_browser" "text" DEFAULT NULL::"text", "p_user_agent" "text" DEFAULT NULL::"text", "p_status" "text" DEFAULT 'online'::"text", "p_server_id" "uuid" DEFAULT NULL::"uuid", "p_channel_id" "uuid" DEFAULT NULL::"uuid", "p_conversation_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_session_id uuid;
...
ALTER FUNCTION "public"."upsert_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_platform" "text", "p_form_factor" "text", "p_is_pwa" boolean, "p_browser" "text", "p_user_agent" "text", "p_status" "text", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."use_one_time_prekey"("p_user_id" "uuid", "p_device_id" "text", "p_prekey_id" integer, "p_used_by" "uuid") RETURNS "public"."prekeys"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_prekey public.prekeys;
...
ALTER FUNCTION "public"."use_one_time_prekey"("p_user_id" "uuid", "p_device_id" "text", "p_prekey_id" integer, "p_used_by" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."user_has_encryption"("p_user_id" "uuid") OWNER TO "supabase_admin";
...
CREATE OR REPLACE FUNCTION "public"."user_has_recovery_key"("p_user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN EXISTS (
...
ALTER FUNCTION "public"."user_has_recovery_key"("p_user_id" "uuid") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."user_is_conversation_member"("p_conversation_id" "uuid", "p_user_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 
...
ALTER FUNCTION "public"."user_is_conversation_member"("p_conversation_id" "uuid", "p_user_id" "uuid") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."verify_bot_token"("p_token_hash" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."verify_recovery_code"("p_user_id" "uuid", "p_code" "text") OWNER TO "supabase_admin";
...
ALTER FUNCTION "public"."verify_user_password"("password" "text") OWNER TO "supabase_admin";


CREATE OR REPLACE FUNCTION "public"."webhook_external_link_previews"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'net', 'extensions'
    AS $$
declare
...
ALTER FUNCTION "public"."webhook_external_link_previews"() OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."archive" OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."job" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-block'::"text"))
);


ALTER TABLE "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-dm'::"text"))
);


ALTER TABLE "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j3f168501ed9816b51a9f5765e0742e1eb034ab6bf72c9ae3f3a975e3" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
...
ALTER TABLE "pgboss"."j3f168501ed9816b51a9f5765e0742e1eb034ab6bf72c9ae3f3a975e3" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-follow'::"text"))
);


ALTER TABLE "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-report'::"text"))
);


ALTER TABLE "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-profile'::"text"))
);


ALTER TABLE "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-reaction'::"text"))
);


ALTER TABLE "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-post'::"text"))
);


ALTER TABLE "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'federate-message-reaction'::"text"))
);


ALTER TABLE "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" OWNER TO "supabase_admin";


CREATE TABLE IF NOT EXISTS "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "priority" integer DEFAULT 0 NOT NULL,
    "data" "jsonb",
    ...
    "dead_letter" "text",
    "policy" "text",
    CONSTRAINT "cjc" CHECK (("name" = 'send-push-notification'::"text"))
);


ALTER TABLE "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."queue" OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."schedule" OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."subscription" OWNER TO "supabase_admin";
...
ALTER TABLE "pgboss"."version" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."activity_processing_logs" OWNER TO "supabase_admin";


CREATE SEQUENCE IF NOT EXISTS "public"."activity_processing_logs_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."activity_processing_logs_id_seq" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."activitypub_processing_stats" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."ap_activities" OWNER TO "postgres";
...
ALTER TABLE "public"."ap_actor_cache" OWNER TO "postgres";
...
ALTER TABLE "public"."ap_object_cache" OWNER TO "postgres";
...
ALTER TABLE "public"."blocked_instances" OWNER TO "postgres";
...
ALTER TABLE "public"."bot_audit_log" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_commands" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_presence" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_rate_limits" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_server_permissions" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_tokens" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."bot_webhooks" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."conversation_backup_pre_cleanup" (
    "id" "uuid",
    "user1" "uuid",
    "user2" "uuid",
...
ALTER TABLE "public"."conversation_backup_pre_cleanup" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."conversation_encryption_settings" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."conversation_participants" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."emoji_usage" OWNER TO "postgres";
...
ALTER TABLE "public"."encryption_audit_log" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."federated_instances" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."federated_voice_calls" (
    ...
    CONSTRAINT "federated_voice_calls_call_type_check" CHECK (("call_type" = ANY (ARRAY['voice'::"text", 'video'::"text"]))),
    CONSTRAINT "federated_voice_calls_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'rejected'::"text", 'ended'::"text", 'expired'::"text", 'missed'::"text"]))),
    CONSTRAINT "fk_recipient_local" CHECK (("recipient_id" IS NOT NULL))
);


ALTER TABLE "public"."federated_voice_calls" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."federation_delivery_queue" OWNER TO "postgres";


COMMENT ON TABLE "public"."federation_delivery_queue" IS 'Queue for ActivityPub federation deliveries. 
...
ALTER TABLE "public"."federation_delivery_stats" OWNER TO "supabase_admin";
...
ALTER VIEW "public"."federation_stats" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."follows" (
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb",
    "federation_status" "text" DEFAULT 'pending'::"text",
    CONSTRAINT "follows_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"]))),
...
ALTER VIEW "public"."follow_relationships" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."hashtag_archive" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."hashtag_archive" OWNER TO "supabase_admin";
...
ALTER VIEW "public"."instance_health" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."instance_webrtc_settings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "webrtc_mode" "text" DEFAULT 'hybrid'::"text" NOT NULL,
    "livekit_url" "text",
    "allow_federated_voice" boolean DEFAULT true NOT NULL,
    "max_stage_speakers" integer DEFAULT 10 NOT NULL,
    "max_stage_listeners" integer DEFAULT 100000 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "instance_webrtc_settings_webrtc_mode_check" CHECK (("webrtc_mode" = ANY (ARRAY['sfu'::"text", 'p2p'::"text", 'hybrid'::"text"])))
);


ALTER TABLE "public"."instance_webrtc_settings" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."megolm_key_backups" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."megolm_key_requests" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."megolm_room_sessions" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."megolm_session_shares" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."message_search_index" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."messages" (
    ...
    CONSTRAINT "messages_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"]))),
...
ALTER TABLE "public"."mfa_recovery_codes" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."notification_rate_limits" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."pg_background_job" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."pg_background_job" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."post_interactions" (
    ...
    "federation_status" "text" DEFAULT 'pending'::"text",
    CONSTRAINT "post_interactions_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"]))),
...
ALTER TABLE "public"."push_subscriptions" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."reactions" (
    ...
    "federation_status" "text" DEFAULT 'pending'::"text",
    "custom_emoji_content" "text",
    CONSTRAINT "reactions_emoji_check" CHECK ((("emoji_id" IS NOT NULL) OR ("custom_emoji_content" IS NOT NULL))),
    CONSTRAINT "reactions_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"]))),
...
COMMENT ON COLUMN "public"."reactions"."user_id" IS 'References profiles.id (not auth.users.id). This allows reactions from both local users (where profiles.id = auth.users.id) and federated/remote users (who only have profiles entries).';
...
COMMENT ON COLUMN "public"."reactions"."custom_emoji_content" IS 'For native emojis: stores the unicode character (e.g., 👍, ❤️). For custom emojis: optionally stores the shortcode for caching. Native emojis have emoji_id=NULL.';
...
ALTER TABLE "public"."remote_emojis_cache" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."reports" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "federation_status" "text" DEFAULT 'pending'::"text",
    CONSTRAINT "reports_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"]))),
...
ALTER TABLE ONLY "public"."reports" REPLICA IDENTITY FULL;
...
CREATE TABLE IF NOT EXISTS "public"."schedule_result" (
    "schedule" bigint
);


ALTER TABLE "public"."schedule_result" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."server_encryption_settings" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."server_federation_events" OWNER TO "postgres";
...
ALTER TABLE "public"."server_membership_events" OWNER TO "postgres";
...
ALTER VIEW "public"."timeline_posts" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."trending_refresh_queue" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."trending_users" OWNER TO "postgres";
...
ALTER TABLE "public"."unread_counts" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_blocks" (
    ...
    CONSTRAINT "user_blocks_federation_status_check" CHECK (("federation_status" = ANY (ARRAY['pending'::"text", 'queued'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"])))
);

ALTER TABLE ONLY "public"."user_blocks" REPLICA IDENTITY FULL;


ALTER TABLE "public"."user_blocks" OWNER TO "supabase_admin";
...
ALTER VIEW "public"."user_bookmarks" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."user_key_pairs" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."user_mutes" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."user_private_keys" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."user_servers" OWNER TO "postgres";
...
ALTER TABLE "public"."user_timeline_cache" OWNER TO "postgres";
...
ALTER TABLE "public"."user_view_contexts" OWNER TO "supabase_admin";
...
CREATE TABLE IF NOT EXISTS "public"."v_has_permission" (
    "send_messages" boolean
);


ALTER TABLE "public"."v_has_permission" OWNER TO "supabase_admin";
...
ALTER VIEW "public"."visible_posts" OWNER TO "supabase_admin";
...
ALTER TABLE "public"."voice_federation_events" OWNER TO "postgres";


ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" FOR VALUES IN ('federate-block');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" FOR VALUES IN ('federate-dm');
...
ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" FOR VALUES IN ('federate-follow');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" FOR VALUES IN ('federate-report');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" FOR VALUES IN ('federate-profile');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" FOR VALUES IN ('federate-reaction');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" FOR VALUES IN ('federate-post');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" FOR VALUES IN ('federate-message-reaction');



ALTER TABLE ONLY "pgboss"."job" ATTACH PARTITION "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" FOR VALUES IN ('send-push-notification');
...
ALTER TABLE ONLY "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33"
    ADD CONSTRAINT "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a"
    ADD CONSTRAINT "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_pkey" PRIMARY KEY ("name", "id");
...
ALTER TABLE ONLY "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07"
    ADD CONSTRAINT "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846"
    ADD CONSTRAINT "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102"
    ADD CONSTRAINT "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba"
    ADD CONSTRAINT "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed"
    ADD CONSTRAINT "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979"
    ADD CONSTRAINT "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_pkey" PRIMARY KEY ("name", "id");



ALTER TABLE ONLY "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8"
    ADD CONSTRAINT "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_pkey" PRIMARY KEY ("name", "id");
...
ALTER TABLE ONLY "public"."federated_voice_calls"
    ADD CONSTRAINT "federated_voice_calls_ap_id_key" UNIQUE ("ap_id");



ALTER TABLE ONLY "public"."federated_voice_calls"
    ADD CONSTRAINT "federated_voice_calls_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."federation_delivery_queue"
    ADD CONSTRAINT "federation_delivery_queue_activity_domain_unique" UNIQUE ("activity_id", "target_domain");
...
ALTER TABLE ONLY "public"."instance_webrtc_settings"
    ADD CONSTRAINT "instance_webrtc_settings_pkey" PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_i1" ON "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_i2" ON "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_i3" ON "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_i4" ON "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_i5" ON "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_i1" ON "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_i2" ON "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_i3" ON "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_i4" ON "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_i5" ON "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");
...
CREATE UNIQUE INDEX "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_i1" ON "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_i2" ON "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_i3" ON "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_i4" ON "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_i5" ON "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_i1" ON "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_i2" ON "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_i3" ON "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_i4" ON "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_i5" ON "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_i1" ON "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_i2" ON "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_i3" ON "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_i4" ON "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_i5" ON "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_i1" ON "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_i2" ON "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_i3" ON "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_i4" ON "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_i5" ON "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_i1" ON "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_i2" ON "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_i3" ON "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_i4" ON "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_i5" ON "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_i1" ON "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_i2" ON "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_i3" ON "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_i4" ON "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_i5" ON "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");



CREATE UNIQUE INDEX "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_i1" ON "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'created'::"pgboss"."job_state") AND ("policy" = 'short'::"text"));



CREATE UNIQUE INDEX "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_i2" ON "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" USING "btree" ("name", COALESCE("singleton_key", ''::"text")) WHERE (("state" = 'active'::"pgboss"."job_state") AND ("policy" = 'singleton'::"text"));



CREATE UNIQUE INDEX "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_i3" ON "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" USING "btree" ("name", "state", COALESCE("singleton_key", ''::"text")) WHERE (("state" <= 'active'::"pgboss"."job_state") AND ("policy" = 'stately'::"text"));



CREATE UNIQUE INDEX "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_i4" ON "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" USING "btree" ("name", "singleton_on", COALESCE("singleton_key", ''::"text")) WHERE (("state" <> 'cancelled'::"pgboss"."job_state") AND ("singleton_on" IS NOT NULL));



CREATE INDEX "jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_i5" ON "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8" USING "btree" ("name", "start_after") INCLUDE ("priority", "created_on", "id") WHERE ("state" < 'active'::"pgboss"."job_state");
...
CREATE INDEX "idx_federated_voice_calls_caller" ON "public"."federated_voice_calls" USING "btree" ("caller_id");



CREATE INDEX "idx_federated_voice_calls_expires" ON "public"."federated_voice_calls" USING "btree" ("expires_at") WHERE ("status" = 'pending'::"text");



CREATE INDEX "idx_federated_voice_calls_recipient" ON "public"."federated_voice_calls" USING "btree" ("recipient_id") WHERE ("status" = 'pending'::"text");



CREATE INDEX "idx_federated_voice_calls_status" ON "public"."federated_voice_calls" USING "btree" ("status");
...
CREATE INDEX "idx_follows_federation_pending" ON "public"."follows" USING "btree" ("federation_status", "created_at") WHERE ("federation_status" = 'pending'::"text");
...
CREATE UNIQUE INDEX "idx_instance_webrtc_settings_singleton" ON "public"."instance_webrtc_settings" USING "btree" ((true));
...
CREATE INDEX "idx_messages_federation_pending" ON "public"."messages" USING "btree" ("federation_status", "created_at") WHERE (("federation_status" = 'pending'::"text") AND ("conversation_id" IS NOT NULL));
...
CREATE INDEX "idx_post_interactions_federation_pending" ON "public"."post_interactions" USING "btree" ("federation_status", "created_at") WHERE ("federation_status" = 'pending'::"text");
...
CREATE INDEX "idx_posts_federated_timeline" ON "public"."posts" USING "btree" ("created_at" DESC) WHERE (("is_local" = false) AND ("visibility" = 'public'::"text") AND (("is_deleted" = false) OR ("is_deleted" IS NULL)) AND ("deleted_at" IS NULL) AND ("in_reply_to" IS NULL));



CREATE INDEX "idx_posts_federation_pending" ON "public"."posts" USING "btree" ("federation_status", "created_at") WHERE (("federation_status" = 'pending'::"text") AND ("is_local" = true));
...
CREATE INDEX "idx_push_subscriptions_failure" ON "public"."push_subscriptions" USING "btree" ("failure_count", "last_failure_at") WHERE ("failure_count" > 0);
...
CREATE INDEX "idx_reactions_custom_emoji" ON "public"."reactions" USING "btree" ("message_id", "custom_emoji_content") WHERE (("custom_emoji_content" IS NOT NULL) AND ("emoji_id" IS NULL));



CREATE INDEX "idx_reactions_federation_pending" ON "public"."reactions" USING "btree" ("federation_status", "created_at") WHERE ("federation_status" = 'pending'::"text");
...
CREATE INDEX "idx_user_sessions_active" ON "public"."user_sessions" USING "btree" ("user_id", "is_active", "last_heartbeat") WHERE ("is_active" = true);



CREATE INDEX "idx_user_sessions_heartbeat" ON "public"."user_sessions" USING "btree" ("last_heartbeat");
...
ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j2bd15923d33d2bf43a1f4c7289e92a1e71968ff48810451fd06cde33_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j3d6c285c35ce067668c2dfde0be7dd7f7090a88b18464ca315c09d8a_pkey";
...
ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j52460a9bc4fee8586726ae74176bd9483261f1453a1244f1e8a4aa07_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j57b1858cdb76a99abbdce180de3b9362747c169b8b04b5f846ff0846_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j64cf8c76a696d680e92ff3a33110be528fc01ecf1288824cd51ab102_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j848607cff6c6a581b7f3a52a0fdbb8a1f9ef136d2fb8c73c0b2204ba_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j912a7b830a1163abc7a86c23f5892115ac0a2b9a21e4515462fe9bed_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."j97fd59325e6da9af31d35277e99b1df9667a8a0c0cf24380d711b979_pkey";



ALTER INDEX "pgboss"."job_pkey" ATTACH PARTITION "pgboss"."jc841062df072f64d0a72cb64fb7d9457b276c64a7df54c3c5c5ab6a8_pkey";



CREATE OR REPLACE TRIGGER "add_posts_to_new_follower_timeline" AFTER INSERT OR UPDATE ON "public"."follows" FOR EACH ROW WHEN (("new"."status" = 'accepted'::"text")) EXECUTE FUNCTION "public"."add_existing_posts_to_new_follower_timeline"();



CREATE OR REPLACE TRIGGER "audit_key_generation" AFTER INSERT ON "public"."user_key_pairs" FOR EACH ROW EXECUTE FUNCTION "public"."log_key_generation"();



CREATE OR REPLACE TRIGGER "auto_create_default_server_structure" AFTER INSERT ON "public"."servers" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_create_default_server_structure"();



CREATE OR REPLACE TRIGGER "auto_set_member_instance" BEFORE INSERT ON "public"."user_servers" FOR EACH ROW EXECUTE FUNCTION "public"."set_member_instance"();
...
CREATE OR REPLACE TRIGGER "backfill_timeline_on_follow_trigger" AFTER INSERT OR UPDATE OF "status" ON "public"."follows" FOR EACH ROW WHEN (("new"."status" = 'accepted'::"text")) EXECUTE FUNCTION "public"."backfill_timeline_on_follow"();



CREATE OR REPLACE TRIGGER "cascade_delete_reblogs_trigger" AFTER UPDATE OF "is_deleted" ON "public"."posts" FOR EACH ROW WHEN ((("new"."is_deleted" = true) AND (("old"."is_deleted" = false) OR ("old"."is_deleted" IS NULL)))) EXECUTE FUNCTION "public"."cascade_delete_reblogs"();



CREATE OR REPLACE TRIGGER "create_comprehensive_timeline_entries_trigger" AFTER INSERT ON "public"."posts" FOR EACH ROW EXECUTE FUNCTION "public"."create_comprehensive_timeline_entries"();



CREATE OR REPLACE TRIGGER "create_notification_preferences_trigger" AFTER INSERT ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."create_notification_preferences"();



CREATE OR REPLACE TRIGGER "extract_hashtags_on_post_insert" AFTER INSERT ON "public"."posts" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_extract_post_hashtags"();



CREATE OR REPLACE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');
...
CREATE OR REPLACE TRIGGER "on_post_soft_delete" AFTER UPDATE OF "is_deleted" ON "public"."posts" FOR EACH ROW EXECUTE FUNCTION "public"."handle_post_soft_delete"();



CREATE OR REPLACE TRIGGER "push_subscriptions_update_timestamp" BEFORE UPDATE ON "public"."push_subscriptions" FOR EACH ROW EXECUTE FUNCTION "public"."update_push_subscription_timestamp"();



CREATE OR REPLACE TRIGGER "remove_timeline_on_unfollow_trigger" BEFORE DELETE ON "public"."follows" FOR EACH ROW EXECUTE FUNCTION "public"."remove_timeline_on_unfollow"();



CREATE OR REPLACE TRIGGER "route_leave_federation" AFTER DELETE ON "public"."user_servers" FOR EACH ROW EXECUTE FUNCTION "public"."route_server_leave"();
...
CREATE OR REPLACE TRIGGER "route_membership_federation" AFTER INSERT OR UPDATE ON "public"."user_servers" FOR EACH ROW EXECUTE FUNCTION "public"."route_server_membership"();
...
CREATE OR REPLACE TRIGGER "smart_route_channel_message" AFTER INSERT ON "public"."messages" FOR EACH ROW WHEN (("new"."channel_id" IS NOT NULL)) EXECUTE FUNCTION "public"."route_channel_message"();
...
CREATE OR REPLACE TRIGGER "trg_handle_message_federation" AFTER INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."handle_message_federation"();



COMMENT ON TRIGGER "trg_handle_message_federation" ON "public"."messages" IS 'Handles LOCAL notifications for all messages (DMs, mentions).
Federation is handled separately by the Node.js backend listening to this table.';



CREATE OR REPLACE TRIGGER "trg_process_local_link_previews" BEFORE INSERT ON "public"."messages" FOR EACH ROW WHEN ((("new"."metadata" ->> 'federated'::"text") IS DISTINCT FROM 'true'::"text")) EXECUTE FUNCTION "public"."process_local_link_previews"();



CREATE OR REPLACE TRIGGER "trg_process_message_link_previews" BEFORE INSERT ON "public"."messages" FOR EACH ROW WHEN ((("new"."metadata" ->> 'federated'::"text") IS DISTINCT FROM 'true'::"text")) EXECUTE FUNCTION "public"."process_message_link_previews"();



CREATE OR REPLACE TRIGGER "trg_webhook_external_link_previews" AFTER INSERT ON "public"."messages" FOR EACH ROW WHEN ((("new"."metadata" ->> 'federated'::"text") IS DISTINCT FROM 'true'::"text")) EXECUTE FUNCTION "public"."webhook_external_link_previews"();



CREATE OR REPLACE TRIGGER "trigger_check_emoji_reaction_limit" BEFORE INSERT ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."check_emoji_reaction_limit"();



CREATE OR REPLACE TRIGGER "trigger_check_message_emoji_reaction_limit" BEFORE INSERT ON "public"."reactions" FOR EACH ROW EXECUTE FUNCTION "public"."check_message_emoji_reaction_limit"();



CREATE OR REPLACE TRIGGER "trigger_federate_block" BEFORE INSERT ON "public"."user_blocks" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_block_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_block_delete" AFTER DELETE ON "public"."user_blocks" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_block_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_dm" BEFORE INSERT ON "public"."messages" FOR EACH ROW WHEN (("new"."conversation_id" IS NOT NULL)) EXECUTE FUNCTION "public"."trigger_queue_dm_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_follow" BEFORE INSERT ON "public"."follows" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_follow_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_follow_delete" AFTER DELETE ON "public"."follows" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_follow_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_message_reaction" BEFORE INSERT ON "public"."reactions" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_message_reaction_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_message_reaction_delete" AFTER DELETE ON "public"."reactions" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_message_reaction_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_post" BEFORE INSERT OR UPDATE ON "public"."posts" FOR EACH ROW WHEN (("new"."is_local" = true)) EXECUTE FUNCTION "public"."trigger_queue_post_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_post_interaction" BEFORE INSERT ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_interaction_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_post_interaction_delete" AFTER DELETE ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_interaction_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_profile" AFTER UPDATE ON "public"."profiles" FOR EACH ROW WHEN (("new"."is_local" = true)) EXECUTE FUNCTION "public"."trigger_queue_profile_federation"();



CREATE OR REPLACE TRIGGER "trigger_federate_report" BEFORE INSERT ON "public"."reports" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_report_federation"();



CREATE OR REPLACE TRIGGER "trigger_handle_local_post_mention_notifications" AFTER INSERT ON "public"."posts" FOR EACH ROW WHEN ((("new"."is_local" = true) AND ("new"."is_federated" = false))) EXECUTE FUNCTION "public"."handle_local_post_mention_notifications"();
...
CREATE OR REPLACE TRIGGER "trigger_handle_post_mention_notifications" AFTER INSERT ON "public"."posts" FOR EACH ROW WHEN (("new"."content" IS NOT NULL)) EXECUTE FUNCTION "public"."handle_post_mention_notifications"();
...
CREATE OR REPLACE TRIGGER "trigger_handle_remote_user_suspension" AFTER UPDATE OF "is_suspended" ON "public"."profiles" FOR EACH ROW WHEN (("new"."is_suspended" = true)) EXECUTE FUNCTION "public"."handle_remote_user_suspension"();



CREATE OR REPLACE TRIGGER "trigger_increment_unread_mentions" AFTER INSERT ON "public"."notifications" FOR EACH ROW WHEN ((("new"."type")::"text" = ANY ((ARRAY['mention'::character varying, 'activitypub_mention'::character varying])::"text"[]))) EXECUTE FUNCTION "public"."increment_unread_mentions"();
...
CREATE OR REPLACE TRIGGER "trigger_index_message" AFTER INSERT OR UPDATE OF "content", "channel_id", "conversation_id", "user_id", "is_deleted" ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."index_message"();



CREATE OR REPLACE TRIGGER "trigger_post_federation" AFTER INSERT ON "public"."posts" FOR EACH ROW EXECUTE FUNCTION "public"."handle_post_federation"();



COMMENT ON TRIGGER "trigger_post_federation" ON "public"."posts" IS 'Automatically federates new local public/unlisted posts to remote instances.';



CREATE OR REPLACE TRIGGER "trigger_post_interaction_federation" AFTER INSERT OR DELETE ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."handle_post_interaction_federation"();
...
CREATE OR REPLACE TRIGGER "trigger_remove_message_index" AFTER DELETE ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."remove_message_from_index"();



CREATE OR REPLACE TRIGGER "trigger_send_push_notification" AFTER INSERT ON "public"."notifications" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_queue_push_notification"();



CREATE OR REPLACE TRIGGER "trigger_unified_interaction_federation_likes" AFTER INSERT OR DELETE ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."handle_unified_interaction_federation"();



CREATE OR REPLACE TRIGGER "trigger_unified_notification_follows" AFTER INSERT ON "public"."follows" FOR EACH ROW EXECUTE FUNCTION "public"."handle_unified_notification_processing"();



CREATE OR REPLACE TRIGGER "trigger_unified_notification_interactions" AFTER INSERT ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."handle_unified_notification_processing"();



CREATE OR REPLACE TRIGGER "trigger_unified_notification_reactions" AFTER INSERT ON "public"."reactions" FOR EACH ROW EXECUTE FUNCTION "public"."handle_unified_notification_processing"();
...
CREATE OR REPLACE TRIGGER "trigger_update_follow_counters" AFTER INSERT OR DELETE OR UPDATE ON "public"."follows" FOR EACH ROW EXECUTE FUNCTION "public"."update_follow_counters"();



CREATE OR REPLACE TRIGGER "trigger_update_post_reaction_counts" AFTER INSERT OR DELETE ON "public"."post_interactions" FOR EACH ROW EXECUTE FUNCTION "public"."update_post_reaction_counts"();



CREATE OR REPLACE TRIGGER "unified_activitypub_processing_trigger" AFTER UPDATE ON "public"."ap_activities" FOR EACH ROW EXECUTE FUNCTION "public"."handle_activitypub_activity_processing"();
...
CREATE OR REPLACE TRIGGER "update_bot_webhooks_timestamp" BEFORE UPDATE ON "public"."bot_webhooks" FOR EACH ROW EXECUTE FUNCTION "public"."update_bot_timestamp"();



CREATE OR REPLACE TRIGGER "update_bots_timestamp" BEFORE UPDATE ON "public"."bots" FOR EACH ROW EXECUTE FUNCTION "public"."update_bot_timestamp"();



CREATE OR REPLACE TRIGGER "update_conversation_encryption_settings_timestamp" BEFORE UPDATE ON "public"."conversation_encryption_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_encryption_timestamp"();



CREATE OR REPLACE TRIGGER "update_megolm_backup_timestamp" BEFORE UPDATE ON "public"."megolm_key_backups" FOR EACH ROW EXECUTE FUNCTION "public"."update_megolm_backup_timestamp"();



CREATE OR REPLACE TRIGGER "update_reblog_count_on_post_delete" AFTER DELETE ON "public"."posts" FOR EACH ROW WHEN ((("old"."metadata" ->> 'reblog_of'::"text") IS NOT NULL)) EXECUTE FUNCTION "public"."update_post_reblog_count"();



CREATE OR REPLACE TRIGGER "update_reblog_count_on_post_insert" AFTER INSERT ON "public"."posts" FOR EACH ROW WHEN ((("new"."metadata" ->> 'reblog_of'::"text") IS NOT NULL)) EXECUTE FUNCTION "public"."update_post_reblog_count"();



CREATE OR REPLACE TRIGGER "update_reblog_count_on_post_update" AFTER UPDATE OF "is_deleted" ON "public"."posts" FOR EACH ROW WHEN (((("new"."metadata" ->> 'reblog_of'::"text") IS NOT NULL) OR (("old"."metadata" ->> 'reblog_of'::"text") IS NOT NULL))) EXECUTE FUNCTION "public"."update_post_reblog_count"();



CREATE OR REPLACE TRIGGER "update_reply_count_on_post_delete" AFTER DELETE ON "public"."posts" FOR EACH ROW WHEN (("old"."in_reply_to" IS NOT NULL)) EXECUTE FUNCTION "public"."update_post_reply_count"();



CREATE OR REPLACE TRIGGER "update_reply_count_on_post_insert_update" AFTER INSERT OR UPDATE OF "is_deleted" ON "public"."posts" FOR EACH ROW WHEN (("new"."in_reply_to" IS NOT NULL)) EXECUTE FUNCTION "public"."update_post_reply_count"();



CREATE OR REPLACE TRIGGER "update_server_encryption_settings_timestamp" BEFORE UPDATE ON "public"."server_encryption_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_encryption_timestamp"();
...
ALTER TABLE ONLY "public"."federated_voice_calls"
    ADD CONSTRAINT "federated_voice_calls_caller_id_fkey" FOREIGN KEY ("caller_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."federated_voice_calls"
    ADD CONSTRAINT "federated_voice_calls_recipient_id_fkey" FOREIGN KEY ("recipient_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_sessions"
    ADD CONSTRAINT "user_sessions_current_channel_id_fkey" FOREIGN KEY ("current_channel_id") REFERENCES "public"."channels"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."user_sessions"
    ADD CONSTRAINT "user_sessions_current_conversation_id_fkey" FOREIGN KEY ("current_conversation_id") REFERENCES "public"."conversations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."user_sessions"
    ADD CONSTRAINT "user_sessions_current_server_id_fkey" FOREIGN KEY ("current_server_id") REFERENCES "public"."servers"("id") ON DELETE SET NULL;
...
COMMENT ON POLICY "Users can check if blocked" ON "public"."user_blocks" IS 'Users can check if they have been blocked by someone';
...
COMMENT ON POLICY "Users can create blocks" ON "public"."user_blocks" IS 'Users can block other users';
...
CREATE POLICY "Users can create post interactions on posts they can see" ON "public"."post_interactions" FOR INSERT WITH CHECK ((("user_id" = "public"."get_current_profile_id"()) AND ("post_id" IN ( SELECT "p"."id"
   FROM "public"."posts" "p"
  WHERE ((("p"."is_deleted" = false) OR ("p"."is_deleted" IS NULL)) AND (COALESCE("public"."is_author_suspended"("p"."author_id"), false) = false) AND (("p"."author_id" = "public"."get_current_profile_id"()) OR ("p"."visibility" = ANY (ARRAY['public'::"text", 'unlisted'::"text"])) OR (("p"."visibility" = 'followers'::"text") AND (EXISTS ( SELECT 1
           FROM "public"."follows" "f"
...
COMMENT ON POLICY "Users can delete own blocks" ON "public"."user_blocks" IS 'Users can unblock users they have blocked';
...
COMMENT ON POLICY "Users can see their own blocks" ON "public"."user_blocks" IS 'Users can view blocks they have created to manage their block list';
...
COMMENT ON POLICY "Users can view non-suspended profiles" ON "public"."profiles" IS 'Users can view their own profile or any non-suspended profile';
...
COMMENT ON POLICY "Users can view posts from users they follow" ON "public"."posts" IS 'Users can view follower-only posts from followed accounts, if not deleted and author not suspended. Safe for federated content.';
...
COMMENT ON POLICY "Users can view public posts" ON "public"."posts" IS 'Anyone can view public/unlisted posts that are not deleted and author is not suspended. Safe for federated content.';
...
COMMENT ON POLICY "Users can view their own posts" ON "public"."posts" IS 'Users can view their own posts only if not deleted. Removed suspension check since users need to see their own posts.';
...
CREATE POLICY "Users can view their timeline entries" ON "public"."timeline_entries" FOR SELECT USING ((("user_id" = "public"."get_current_profile_id"()) AND ("post_id" IN ( SELECT "p"."id"
   FROM "public"."posts" "p"
  WHERE ((("p"."is_deleted" = false) OR ("p"."is_deleted" IS NULL)) AND (COALESCE("public"."is_author_suspended"("p"."author_id"), false) = false))))));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."megolm_key_requests";
...
GRANT ALL ON FUNCTION "public"."add_bot_to_server"("p_bot_id" "uuid", "p_server_id" "uuid", "p_installed_by" "uuid", "p_permissions" "jsonb") TO "authenticated";



GRANT ALL ON FUNCTION "public"."add_user_prekeys"("p_user_id" "uuid", "p_device_id" "text", "p_prekeys" "jsonb") TO "authenticated";



GRANT ALL ON FUNCTION "public"."add_user_to_conversation"("conversation_uuid" "uuid", "user_uuid" "uuid", "user_role" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."build_post_create_activity"("p_post_id" "uuid", "p_author_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."check_bot_permission"("p_bot_id" "uuid", "p_server_id" "uuid", "p_permission" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_bot_permission"("p_bot_id" "uuid", "p_server_id" "uuid", "p_permission" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."check_encryption_policy"("p_server_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."claim_session_share"("p_share_id" "uuid", "p_user_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."cleanup_stale_push_subscriptions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_stale_push_subscriptions"() TO "service_role";



GRANT ALL ON FUNCTION "public"."cleanup_stale_user_sessions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_stale_user_sessions"() TO "service_role";



GRANT ALL ON FUNCTION "public"."count_unused_recovery_codes"("p_user_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."create_default_server_structure"("p_server_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."create_federated_emoji"("p_name" "text", "p_url" "text", "p_uploader" "uuid", "p_domain" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."create_or_get_direct_conversation"("user1_uuid" "uuid", "user2_uuid" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."delete_push_subscription_by_endpoint"("p_endpoint" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_push_subscription_by_endpoint"("p_endpoint" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."detect_message_features"("content_parts" "jsonb") TO "authenticated";



GRANT ALL ON FUNCTION "public"."enable_conversation_encryption"("p_conversation_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."end_user_session"("p_session_token" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."end_user_session"("p_session_token" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."extract_message_text"("content_parts" "jsonb") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."fetch_link_preview"("p_url" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."fetch_link_preview"("p_url" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."fetch_link_preview"("p_url" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_channel_server_id"("channel_uuid" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_conversation_encryption_status"("p_conversation_id" "uuid") TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."encryption_sessions" TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_local_device_id" "text", "p_remote_device_id" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_featured_posts_hybrid"("p_author_id" "uuid", "p_limit" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."get_featured_posts_hybrid"("p_author_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_featured_posts_hybrid"("p_author_id" "uuid", "p_limit" integer) TO "anon";



GRANT ALL ON FUNCTION "public"."get_federated_timeline"("p_user_id" "uuid", "p_limit" integer, "p_max_id" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_federated_timeline"("p_user_id" "uuid", "p_limit" integer, "p_max_id" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_instance_domain"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_instance_domain"() TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_pending_reports_count"() TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_public_federation_settings"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_public_federation_settings"() TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_public_instance_info"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_public_instance_info"() TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_reports_with_details"("p_status" "text", "p_limit" integer, "p_offset" integer) TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_server_encryption_policy"("p_server_id" "uuid") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_unclaimed_session_shares"("p_user_id" "uuid") TO "authenticated";



GRANT SELECT,INSERT,UPDATE ON TABLE "public"."prekeys" TO "authenticated";



GRANT ALL ON FUNCTION "public"."get_user_featured_posts"("p_author_id" "uuid", "p_limit" integer) TO "service_role";
GRANT ALL ON FUNCTION "public"."get_user_featured_posts"("p_author_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_featured_posts"("p_author_id" "uuid", "p_limit" integer) TO "anon";



GRANT ALL ON FUNCTION "public"."get_user_prekey_bundle"("p_user_id" "uuid", "p_device_id" "text") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_user_private_key"("p_user_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_user_private_key"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_user_push_subscriptions"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_push_subscriptions"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_activitypub_activity_processing"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_activitypub_activity_processing"() TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_post_federation"() TO "authenticated";



GRANT ALL ON FUNCTION "public"."has_active_session"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_active_session"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."import_remote_emoji"("p_remote_emoji_id" "uuid", "p_new_name" "text", "p_server_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."initialize_user_encryption"("p_user_id" "uuid", "p_identity_public_key" "text", "p_identity_private_key_encrypted" "text", "p_device_id" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."is_activitypub_direct_message"("object_data" "jsonb", "instance_domain" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_activitypub_direct_message"("object_data" "jsonb", "instance_domain" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_author_suspended"("p_author_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_author_suspended"("p_author_id" "uuid") TO "anon";



GRANT ALL ON FUNCTION "public"."is_user_viewing_push_context"("p_user_id" "uuid", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_user_viewing_push_context"("p_user_id" "uuid", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."log_activity_processing_event"("p_activity_id" "uuid", "p_ap_id" "text", "p_ap_type" "text", "p_status" "text", "p_error_message" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_activity_processing_event"("p_activity_id" "uuid", "p_ap_id" "text", "p_ap_type" "text", "p_status" "text", "p_error_message" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_activitypub_public_post"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_activitypub_public_post"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_announce_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_announce_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_delete_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_delete_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_follow_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_follow_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record", "instance_domain" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_like_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_like_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_reject_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_reject_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_undo_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_undo_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."process_update_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_update_activity"("activity_id" "uuid", "activity_data" "jsonb", "actor_profile" "record") TO "service_role";



GRANT ALL ON FUNCTION "public"."queue_activity_for_federation"("p_activity_id" "uuid", "p_target_domains" "text"[], "p_priority" integer, "p_immediate" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."queue_activity_for_federation"("p_activity_id" "uuid", "p_target_domains" "text"[], "p_priority" integer, "p_immediate" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."record_push_failure"("p_subscription_id" "uuid", "p_reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_push_failure"("p_subscription_id" "uuid", "p_reason" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."record_push_success"("p_subscription_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_push_success"("p_subscription_id" "uuid") TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."recovery_key_metadata" TO "authenticated";



GRANT ALL ON FUNCTION "public"."register_recovery_key"("p_user_id" "uuid", "p_verification_code" "text", "p_word_count" integer) TO "authenticated";



GRANT ALL ON FUNCTION "public"."reset_user_encryption"("p_user_id" "uuid", "p_device_id" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."rotate_prekeys"("p_user_id" "uuid", "p_device_id" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."save_encryption_session"("p_local_user_id" "uuid", "p_remote_user_id" "uuid", "p_session_state" "text", "p_local_device_id" "text", "p_remote_device_id" "text") TO "authenticated";



GRANT ALL ON FUNCTION "public"."save_recovery_codes"("p_user_id" "uuid", "p_codes" "text"[]) TO "authenticated";



GRANT ALL ON FUNCTION "public"."search_messages"("p_query" "text", "p_channel_id" "uuid", "p_channel_ids" "uuid"[], "p_user_id" "uuid", "p_conversation_id" "uuid", "p_server_id" "uuid", "p_has_media" boolean, "p_has_url" boolean, "p_from_date" timestamp with time zone, "p_to_date" timestamp with time zone, "p_limit" integer, "p_offset" integer) TO "authenticated";



GRANT ALL ON FUNCTION "public"."trigger_create_default_server_structure"() TO "authenticated";



REVOKE ALL ON FUNCTION "public"."update_message_embeds"("p_message_id" "uuid", "p_embeds" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_message_embeds"("p_message_id" "uuid", "p_embeds" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."upsert_remote_emoji"("p_shortcode" "text", "p_origin_domain" "text", "p_full_code" "text", "p_url" "text", "p_static_url" "text", "p_category" "text", "p_is_animated" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_remote_emoji"("p_shortcode" "text", "p_origin_domain" "text", "p_full_code" "text", "p_url" "text", "p_static_url" "text", "p_category" "text", "p_is_animated" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."upsert_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_platform" "text", "p_form_factor" "text", "p_is_pwa" boolean, "p_browser" "text", "p_user_agent" "text", "p_status" "text", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_platform" "text", "p_form_factor" "text", "p_is_pwa" boolean, "p_browser" "text", "p_user_agent" "text", "p_status" "text", "p_server_id" "uuid", "p_channel_id" "uuid", "p_conversation_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."user_has_encryption"("p_user_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."user_has_recovery_key"("p_user_id" "uuid") TO "authenticated";



GRANT ALL ON FUNCTION "public"."verify_bot_token"("p_token_hash" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."verify_bot_token"("p_token_hash" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."verify_recovery_code"("p_user_id" "uuid", "p_code" "text") TO "authenticated";
...
GRANT USAGE ON SEQUENCE "public"."activity_processing_logs_id_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."admin_audit_log" TO "authenticated";
GRANT SELECT ON TABLE "public"."admin_audit_log" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."admin_audit_log" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_activities" TO "authenticated";
GRANT SELECT ON TABLE "public"."ap_activities" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_activities" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_actor_cache" TO "authenticated";
GRANT SELECT ON TABLE "public"."ap_actor_cache" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_actor_cache" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_object_cache" TO "authenticated";
GRANT SELECT ON TABLE "public"."ap_object_cache" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."ap_object_cache" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."blocked_instances" TO "authenticated";
GRANT SELECT ON TABLE "public"."blocked_instances" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."blocked_instances" TO "service_role";



GRANT SELECT,INSERT ON TABLE "public"."bot_audit_log" TO "service_role";
GRANT SELECT,INSERT ON TABLE "public"."bot_audit_log" TO "authenticated";
...
GRANT SELECT ON TABLE "public"."bot_presence" TO "authenticated";



GRANT SELECT,INSERT,UPDATE ON TABLE "public"."bot_server_permissions" TO "authenticated";
GRANT SELECT ON TABLE "public"."bot_server_permissions" TO "service_role";



GRANT SELECT,INSERT,UPDATE ON TABLE "public"."bot_tokens" TO "authenticated";
GRANT SELECT ON TABLE "public"."bot_tokens" TO "service_role";



GRANT SELECT ON TABLE "public"."bots" TO "authenticated";
GRANT SELECT,UPDATE ON TABLE "public"."bots" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."channel_categories" TO "authenticated";
GRANT SELECT ON TABLE "public"."channel_categories" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."channel_categories" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."channels" TO "authenticated";
GRANT SELECT ON TABLE "public"."channels" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."channels" TO "service_role";



GRANT SELECT,INSERT,UPDATE ON TABLE "public"."conversation_encryption_settings" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."emoji_usage" TO "authenticated";
GRANT SELECT ON TABLE "public"."emoji_usage" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."emoji_usage" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."emojis" TO "authenticated";
GRANT SELECT ON TABLE "public"."emojis" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."emojis" TO "service_role";



GRANT SELECT,INSERT ON TABLE "public"."encryption_audit_log" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."federated_instances" TO "authenticated";
GRANT SELECT ON TABLE "public"."federated_instances" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."federated_instances" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."federation_delivery_queue" TO "authenticated";
GRANT SELECT ON TABLE "public"."federation_delivery_queue" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."federation_delivery_queue" TO "service_role";



GRANT SELECT ON TABLE "public"."federation_stats" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."files" TO "authenticated";
GRANT SELECT ON TABLE "public"."files" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."files" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."follows" TO "authenticated";
GRANT SELECT ON TABLE "public"."follows" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."follows" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."hashtags" TO "authenticated";
GRANT SELECT ON TABLE "public"."hashtags" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."hashtags" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."instance_config" TO "authenticated";
GRANT SELECT ON TABLE "public"."instance_config" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."instance_config" TO "service_role";



GRANT SELECT ON TABLE "public"."instance_health" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."megolm_key_backups" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."megolm_key_requests" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."megolm_room_sessions" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."megolm_session_shares" TO "authenticated";



GRANT SELECT ON TABLE "public"."message_search_index" TO "authenticated";
GRANT SELECT ON TABLE "public"."message_search_index" TO "anon";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."notification_channels" TO "authenticated";
GRANT SELECT ON TABLE "public"."notification_channels" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."notification_channels" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."pg_background_job" TO "authenticated";
GRANT SELECT ON TABLE "public"."pg_background_job" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."pg_background_job" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."post_hashtags" TO "authenticated";
GRANT SELECT ON TABLE "public"."post_hashtags" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."post_hashtags" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."post_interactions" TO "authenticated";
GRANT SELECT ON TABLE "public"."post_interactions" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."post_interactions" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."post_interactions" TO "supabase_realtime_admin";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."reactions" TO "service_role";



GRANT SELECT ON TABLE "public"."remote_emojis_cache" TO "authenticated";
GRANT SELECT ON TABLE "public"."remote_emojis_cache" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."remote_emojis_cache" TO "service_role";
...
GRANT SELECT,INSERT,UPDATE ON TABLE "public"."server_encryption_settings" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."server_federation_events" TO "authenticated";
GRANT SELECT ON TABLE "public"."server_federation_events" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."server_federation_events" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."server_membership_events" TO "authenticated";
GRANT SELECT ON TABLE "public"."server_membership_events" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."server_membership_events" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."servers" TO "authenticated";
GRANT SELECT ON TABLE "public"."servers" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."servers" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."timeline_entries" TO "authenticated";
GRANT SELECT ON TABLE "public"."timeline_entries" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."timeline_entries" TO "service_role";



GRANT SELECT ON TABLE "public"."timeline_posts" TO "authenticated";
GRANT SELECT ON TABLE "public"."timeline_posts" TO "anon";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."trending_posts" TO "authenticated";
GRANT SELECT ON TABLE "public"."trending_posts" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."trending_posts" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."trending_users" TO "authenticated";
GRANT SELECT ON TABLE "public"."trending_users" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."trending_users" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."unread_counts" TO "authenticated";
GRANT SELECT ON TABLE "public"."unread_counts" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."unread_counts" TO "service_role";
...
GRANT SELECT,INSERT,UPDATE ON TABLE "public"."user_key_pairs" TO "authenticated";



GRANT SELECT ON TABLE "public"."user_mutes" TO "authenticated";
GRANT SELECT ON TABLE "public"."user_mutes" TO "service_role";



GRANT SELECT ON TABLE "public"."user_private_keys" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_servers" TO "authenticated";
GRANT SELECT ON TABLE "public"."user_servers" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_servers" TO "service_role";



GRANT USAGE ON SEQUENCE "public"."user_servers_id_seq" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_timeline_cache" TO "authenticated";
GRANT SELECT ON TABLE "public"."user_timeline_cache" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."user_timeline_cache" TO "service_role";



GRANT SELECT ON TABLE "public"."visible_posts" TO "authenticated";
GRANT SELECT ON TABLE "public"."visible_posts" TO "anon";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."voice_federation_events" TO "authenticated";
GRANT SELECT ON TABLE "public"."voice_federation_events" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."voice_federation_events" TO "service_role";
