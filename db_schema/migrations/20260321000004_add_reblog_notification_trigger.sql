...
-- Fix handle_unified_notification_processing:
-- 1. Add 'reblog' to post_interactions handling (was silently ignored → no activitypub_reblog notifications)
-- 2. Enrich reaction notifications with channel_name and server_name for better UI display
