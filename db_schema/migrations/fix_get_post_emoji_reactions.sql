-- Professional approach: Optimized post emoji reactions with user limit and batch support
...
-- Batch function for efficient multi-post loading (eliminates N+1 queries)
...
COMMENT ON FUNCTION public.get_post_emoji_reactions(p_post_id uuid) IS 'Get emoji reactions for a post, grouped by emoji with counts and user lists. Fixed character varying to text type casting and includes user profile data for tooltips.';
