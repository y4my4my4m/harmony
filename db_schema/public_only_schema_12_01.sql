...
--
-- Name: build_post_create_activity(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.build_post_create_activity(p_post_id uuid, p_author_id uuid) RETURNS jsonb
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    v_post RECORD;
...
--
-- Name: FUNCTION build_post_create_activity(p_post_id uuid, p_author_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: cleanup_expired_voice_calls(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_expired_voice_calls() RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: cleanup_stale_push_subscriptions(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_stale_push_subscriptions() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    deleted_count integer;
...
--
-- Name: FUNCTION cleanup_stale_push_subscriptions(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: cleanup_stale_user_sessions(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_stale_user_sessions() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    deleted_count integer;
...
--
-- Name: convert_content_to_html(jsonb, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.convert_content_to_html(p_content jsonb, p_instance_domain text) RETURNS text
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    v_html text;
...
--
-- Name: FUNCTION convert_content_to_html(p_content jsonb, p_instance_domain text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: delete_push_subscription_by_endpoint(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_push_subscription_by_endpoint(p_endpoint text) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    AS $$
...
--
-- Name: disable_federation_triggers(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.disable_federation_triggers() RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: FUNCTION disable_federation_triggers(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: enable_federation_triggers(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enable_federation_triggers() RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: FUNCTION enable_federation_triggers(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: end_user_session(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.end_user_session(p_session_token text) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    AS $$
    UPDATE public.user_sessions
...
CREATE FUNCTION public.get_batch_message_reactions(message_ids uuid[]) RETURNS TABLE(message_id uuid, emoji_id uuid, emoji_name character varying, emoji_url character varying, custom_emoji_content text, reaction_count bigint, users jsonb)
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION get_batch_post_emoji_reactions(p_post_ids uuid[], p_user_limit integer); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_federated_timeline(uuid, integer, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_federated_timeline(p_user_id uuid, p_limit integer, p_max_id text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_post_emoji_reactions(p_post_id uuid, p_user_limit integer); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_user_push_subscriptions(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_push_subscriptions(p_user_id uuid) RETURNS TABLE(subscription_id uuid, endpoint text, p256dh text, auth text, push_enabled boolean, push_offline_only boolean)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION get_user_push_subscriptions(p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: handle_post_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.handle_post_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_author RECORD;
...
--
-- Name: FUNCTION handle_post_federation(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: is_author_suspended(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_author_suspended(p_author_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
...
--
-- Name: FUNCTION is_author_suspended(p_author_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: is_user_viewing_push_context(uuid, uuid, uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_user_viewing_push_context(p_user_id uuid, p_server_id uuid DEFAULT NULL::uuid, p_channel_id uuid DEFAULT NULL::uuid, p_conversation_id uuid DEFAULT NULL::uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
    SELECT EXISTS (
        SELECT 1 FROM public.user_sessions
...
--
-- Name: queue_activity_for_federation(uuid, text[], integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.queue_activity_for_federation(p_activity_id uuid, p_target_domains text[], p_priority integer DEFAULT 5, p_immediate boolean DEFAULT false) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: FUNCTION queue_activity_for_federation(p_activity_id uuid, p_target_domains text[], p_priority integer, p_immediate boolean); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: queue_federation_job(text, jsonb, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.queue_federation_job(p_job_name text, p_job_data jsonb, p_priority integer DEFAULT 5, p_retry_limit integer DEFAULT 5, p_expire_in_seconds integer DEFAULT 3600) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_job_id uuid;
...
--
-- Name: FUNCTION queue_federation_job(p_job_name text, p_job_data jsonb, p_priority integer, p_retry_limit integer, p_expire_in_seconds integer); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: record_push_failure(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.record_push_failure(p_subscription_id uuid, p_reason text DEFAULT NULL::text) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    AS $$
...
--
-- Name: record_push_success(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.record_push_success(p_subscription_id uuid) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    AS $$
    UPDATE public.push_subscriptions
    SET 
...
--
-- Name: trigger_queue_block_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_block_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
--
-- Name: trigger_queue_dm_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_dm_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: trigger_queue_follow_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_follow_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: trigger_queue_interaction_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_interaction_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
--
-- Name: trigger_queue_message_reaction_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_message_reaction_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    IF TG_OP = 'INSERT' THEN
...
--
-- Name: trigger_queue_post_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_post_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: trigger_queue_profile_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_profile_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_job_id uuid;
...
--
-- Name: FUNCTION trigger_queue_profile_federation(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: trigger_queue_push_notification(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_push_notification() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: trigger_queue_report_federation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_queue_report_federation() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    NEW.federation_status := 'queued';
...
--
-- Name: FUNCTION update_post_reply_count(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: update_push_subscription_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: upsert_user_session(uuid, text, text, text, boolean, text, text, text, uuid, uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.upsert_user_session(p_user_id uuid, p_session_token text, p_platform text DEFAULT 'web'::text, p_form_factor text DEFAULT 'desktop'::text, p_is_pwa boolean DEFAULT false, p_browser text DEFAULT NULL::text, p_user_agent text DEFAULT NULL::text, p_status text DEFAULT 'online'::text, p_server_id uuid DEFAULT NULL::uuid, p_channel_id uuid DEFAULT NULL::uuid, p_conversation_id uuid DEFAULT NULL::uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_session_id uuid;
...
--
-- Name: federated_voice_calls; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE federated_voice_calls; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: instance_webrtc_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.instance_webrtc_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: TABLE instance_webrtc_settings; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN push_subscriptions.failure_count; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN reactions.user_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN reactions.custom_emoji_content; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls federated_voice_calls_ap_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls federated_voice_calls_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: federation_delivery_queue federation_delivery_queue_activity_domain_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instance_webrtc_settings instance_webrtc_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_federated_voice_calls_caller; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_federated_voice_calls_expires; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_federated_voice_calls_recipient; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_federated_voice_calls_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_follows_federation_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_instance_webrtc_settings_singleton; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_messages_federation_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_post_interactions_federation_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_posts_federated_timeline; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_posts_federation_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_push_subscriptions_failure; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reactions_custom_emoji; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_reactions_federation_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_sessions_heartbeat; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: push_subscriptions push_subscriptions_update_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER push_subscriptions_update_timestamp BEFORE UPDATE ON public.push_subscriptions FOR EACH ROW EXECUTE FUNCTION public.update_push_subscription_timestamp();
...
--
-- Name: user_blocks trigger_federate_block; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_block BEFORE INSERT ON public.user_blocks FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_block_federation();


--
-- Name: user_blocks trigger_federate_block_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_block_delete AFTER DELETE ON public.user_blocks FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_block_federation();


--
-- Name: messages trigger_federate_dm; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_dm BEFORE INSERT ON public.messages FOR EACH ROW WHEN ((new.conversation_id IS NOT NULL)) EXECUTE FUNCTION public.trigger_queue_dm_federation();


--
-- Name: follows trigger_federate_follow; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_follow BEFORE INSERT ON public.follows FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_follow_federation();


--
-- Name: follows trigger_federate_follow_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_follow_delete AFTER DELETE ON public.follows FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_follow_federation();


--
-- Name: reactions trigger_federate_message_reaction; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_message_reaction BEFORE INSERT ON public.reactions FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_message_reaction_federation();


--
-- Name: reactions trigger_federate_message_reaction_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_message_reaction_delete AFTER DELETE ON public.reactions FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_message_reaction_federation();


--
-- Name: posts trigger_federate_post; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_post BEFORE INSERT OR UPDATE ON public.posts FOR EACH ROW WHEN ((new.is_local = true)) EXECUTE FUNCTION public.trigger_queue_post_federation();


--
-- Name: post_interactions trigger_federate_post_interaction; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_post_interaction BEFORE INSERT ON public.post_interactions FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_interaction_federation();


--
-- Name: post_interactions trigger_federate_post_interaction_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_post_interaction_delete AFTER DELETE ON public.post_interactions FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_interaction_federation();


--
-- Name: profiles trigger_federate_profile; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_profile AFTER UPDATE ON public.profiles FOR EACH ROW WHEN ((new.is_local = true)) EXECUTE FUNCTION public.trigger_queue_profile_federation();


--
-- Name: reports trigger_federate_report; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_federate_report BEFORE INSERT ON public.reports FOR EACH ROW EXECUTE FUNCTION public.trigger_queue_report_federation();
...
--
-- Name: posts trigger_post_federation; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_post_federation AFTER INSERT ON public.posts FOR EACH ROW EXECUTE FUNCTION public.handle_post_federation();


--
-- Name: TRIGGER trigger_post_federation ON posts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls federated_voice_calls_caller_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls federated_voice_calls_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_sessions user_sessions_current_channel_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_sessions user_sessions_current_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_sessions user_sessions_current_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: instance_webrtc_settings Admins can update webrtc settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: instance_webrtc_settings Anyone can read webrtc settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls Recipients can update call status; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: push_subscriptions Service role can manage all push subscriptions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls System can insert calls; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_blocks Users can check if blocked; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can check if blocked" ON user_blocks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can create blocks" ON user_blocks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: user_blocks Users can delete own blocks; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can delete own blocks" ON user_blocks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: user_blocks Users can see their own blocks; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can see their own blocks" ON user_blocks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: profiles Users can view non-suspended profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can view non-suspended profiles" ON profiles; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can view posts from users they follow" ON posts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can view public posts" ON posts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: posts Users can view their deleted posts; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls Users can view their own calls; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY "Users can view their own posts" ON posts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: timeline_entries Users can view their timeline entries; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: federated_voice_calls; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: instance_webrtc_settings; Type: ROW SECURITY; Schema: public; Owner: -
--
