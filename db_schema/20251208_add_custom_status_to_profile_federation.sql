-- =============================================
-- Add custom_status to profile federation trigger
-- =============================================
-- This ensures custom status updates are federated when they change

-- Update the trigger function to include custom_status in the check
...
COMMENT ON FUNCTION "public"."trigger_queue_profile_federation"() IS 'Queue profile updates for federation via pg-boss. Includes custom_status. Requires pg-boss for follower enumeration. Safe - does not break on missing tables.';
