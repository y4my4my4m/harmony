...
DROP POLICY IF EXISTS "Application controlled group icon uploads" ON storage.objects;
DROP POLICY IF EXISTS "Application controlled group icon updates" ON storage.objects;
DROP POLICY IF EXISTS "Application controlled group icon deletes" ON storage.objects;
...
DROP POLICY IF EXISTS "Anyone can view emojis" ON storage.objects;
DROP POLICY IF EXISTS "Anyone can view banners" ON storage.objects;
DROP POLICY IF EXISTS "Anyone can view avatars" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can upload server icons" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can upload emojis" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can update server icons" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can update emojis" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can delete server icons" ON storage.objects;
DROP POLICY IF EXISTS "Admins and server owners can delete emojis" ON storage.objects;
DROP POLICY IF EXISTS server_delete_policy ON public.servers;
...
DROP POLICY IF EXISTS "Users can create background jobs" ON public.pg_background_job;
...
DROP POLICY IF EXISTS "Update" ON public.servers;
...
DROP POLICY IF EXISTS "Instance config admin access" ON public.instance_config;
...
ALTER TABLE IF EXISTS ONLY public.voice_federation_events DROP CONSTRAINT IF EXISTS voice_federation_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.voice_federation_events DROP CONSTRAINT IF EXISTS voice_federation_events_ap_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_timeline_cache DROP CONSTRAINT IF EXISTS user_timeline_cache_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_servers DROP CONSTRAINT IF EXISTS user_servers_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_servers DROP CONSTRAINT IF EXISTS user_servers_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_private_keys DROP CONSTRAINT IF EXISTS user_private_keys_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_mutes DROP CONSTRAINT IF EXISTS user_mutes_muter_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_mutes DROP CONSTRAINT IF EXISTS user_mutes_muted_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.unread_counts DROP CONSTRAINT IF EXISTS unread_counts_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.unread_counts DROP CONSTRAINT IF EXISTS unread_counts_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.unread_counts DROP CONSTRAINT IF EXISTS unread_counts_conversation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.unread_counts DROP CONSTRAINT IF EXISTS unread_counts_channel_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trending_users DROP CONSTRAINT IF EXISTS trending_users_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trending_posts DROP CONSTRAINT IF EXISTS trending_posts_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.timeline_entries DROP CONSTRAINT IF EXISTS timeline_entries_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.timeline_entries DROP CONSTRAINT IF EXISTS timeline_entries_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.servers DROP CONSTRAINT IF EXISTS servers_owner_fkey;
ALTER TABLE IF EXISTS ONLY public.server_membership_events DROP CONSTRAINT IF EXISTS server_membership_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.server_membership_events DROP CONSTRAINT IF EXISTS server_membership_events_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.server_membership_events DROP CONSTRAINT IF EXISTS server_membership_events_initiated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.server_federation_events DROP CONSTRAINT IF EXISTS server_federation_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.server_federation_events DROP CONSTRAINT IF EXISTS server_federation_events_ap_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reactions DROP CONSTRAINT IF EXISTS reactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reactions DROP CONSTRAINT IF EXISTS reactions_message_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reactions DROP CONSTRAINT IF EXISTS reactions_emoji_id_fkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_auth_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS posts_in_reply_to_fkey;
...
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_emoji_id_fkey;
ALTER TABLE IF EXISTS ONLY public.post_hashtags DROP CONSTRAINT IF EXISTS post_hashtags_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.post_hashtags DROP CONSTRAINT IF EXISTS post_hashtags_hashtag_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_rate_limits DROP CONSTRAINT IF EXISTS notification_rate_limits_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_rate_limits DROP CONSTRAINT IF EXISTS notification_rate_limits_source_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.notification_channels DROP CONSTRAINT IF EXISTS notification_channels_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_channels DROP CONSTRAINT IF EXISTS notification_channels_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_channels DROP CONSTRAINT IF EXISTS notification_channels_conversation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_channels DROP CONSTRAINT IF EXISTS notification_channels_channel_id_fkey;
ALTER TABLE IF EXISTS ONLY public.messages DROP CONSTRAINT IF EXISTS messages_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.messages DROP CONSTRAINT IF EXISTS messages_reply_to_fkey;
...
ALTER TABLE IF EXISTS ONLY public.invites DROP CONSTRAINT IF EXISTS invites_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invites DROP CONSTRAINT IF EXISTS invites_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.instance_config DROP CONSTRAINT IF EXISTS instance_config_updated_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.files DROP CONSTRAINT IF EXISTS files_owner_fkey;
ALTER TABLE IF EXISTS ONLY public.federation_delivery_queue DROP CONSTRAINT IF EXISTS federation_delivery_queue_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.emojis DROP CONSTRAINT IF EXISTS emojis_uploader_fkey;
ALTER TABLE IF EXISTS ONLY public.emojis DROP CONSTRAINT IF EXISTS emojis_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.emoji_usage DROP CONSTRAINT IF EXISTS emoji_usage_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.emoji_usage DROP CONSTRAINT IF EXISTS emoji_usage_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.emoji_usage DROP CONSTRAINT IF EXISTS emoji_usage_emoji_id_fkey;
ALTER TABLE IF EXISTS ONLY public.conversations DROP CONSTRAINT IF EXISTS conversations_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.conversation_participants DROP CONSTRAINT IF EXISTS conversation_participants_user_fkey;
ALTER TABLE IF EXISTS ONLY public.conversation_participants DROP CONSTRAINT IF EXISTS conversation_participants_conversation_fkey;
ALTER TABLE IF EXISTS ONLY public.channels DROP CONSTRAINT IF EXISTS channels_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.channels DROP CONSTRAINT IF EXISTS channels_category_fkey;
ALTER TABLE IF EXISTS ONLY public.channel_categories DROP CONSTRAINT IF EXISTS channel_categories_server_id_fkey;
ALTER TABLE IF EXISTS ONLY public.blocked_instances DROP CONSTRAINT IF EXISTS blocked_instances_blocked_by_fkey;
ALTER TABLE IF EXISTS ONLY public.ap_activities DROP CONSTRAINT IF EXISTS ap_activities_actor_id_fkey;
...
DROP TRIGGER IF EXISTS trigger_unified_interaction_federation_likes ON public.post_interactions;
...
DROP INDEX IF EXISTS public.timeline_posts_visibility_created_idx;
DROP INDEX IF EXISTS public.timeline_posts_local_created_idx;
DROP INDEX IF EXISTS public.idx_voice_federation_events_user;
DROP INDEX IF EXISTS public.idx_voice_federation_events_session;
DROP INDEX IF EXISTS public.idx_voice_federation_events_channel;
DROP INDEX IF EXISTS public.idx_user_timeline_cache_posts;
DROP INDEX IF EXISTS public.idx_user_timeline_cache_lookup;
DROP INDEX IF EXISTS public.idx_user_servers_status;
DROP INDEX IF EXISTS public.idx_user_servers_by_instance;
DROP INDEX IF EXISTS public.idx_user_mutes_muter;
DROP INDEX IF EXISTS public.idx_user_blocks_blocker;
DROP INDEX IF EXISTS public.idx_user_blocks_blocked;
DROP INDEX IF EXISTS public.idx_unread_counts_unique;
DROP INDEX IF EXISTS public.idx_trending_users_score;
DROP INDEX IF EXISTS public.idx_trending_users_rank;
DROP INDEX IF EXISTS public.idx_trending_users_period;
DROP INDEX IF EXISTS public.idx_trending_posts_score;
DROP INDEX IF EXISTS public.idx_trending_posts_rank;
DROP INDEX IF EXISTS public.idx_trending_posts_period;
DROP INDEX IF EXISTS public.idx_trending_posts_engagement;
DROP INDEX IF EXISTS public.idx_timeline_entries_user_timeline;
DROP INDEX IF EXISTS public.idx_timeline_entries_user_home_position;
DROP INDEX IF EXISTS public.idx_timeline_entries_unique;
DROP INDEX IF EXISTS public.idx_timeline_entries_post_id;
DROP INDEX IF EXISTS public.idx_servers_federation;
DROP INDEX IF EXISTS public.idx_servers_ap_id;
DROP INDEX IF EXISTS public.idx_server_membership_events_user_id;
DROP INDEX IF EXISTS public.idx_server_membership_events_server_id;
DROP INDEX IF EXISTS public.idx_server_membership_events_server_event;
DROP INDEX IF EXISTS public.idx_server_membership_events_created_at;
DROP INDEX IF EXISTS public.idx_server_federation_events_user;
DROP INDEX IF EXISTS public.idx_server_federation_events_server;
DROP INDEX IF EXISTS public.idx_server_federation_events_domain;
DROP INDEX IF EXISTS public.idx_reactions_user_message;
DROP INDEX IF EXISTS public.idx_reactions_message_user_emoji;
DROP INDEX IF EXISTS public.idx_profiles_username_domain;
DROP INDEX IF EXISTS public.idx_profiles_shared_inbox_url;
DROP INDEX IF EXISTS public.idx_profiles_manually_approves;
DROP INDEX IF EXISTS public.idx_profiles_is_local_username;
DROP INDEX IF EXISTS public.idx_profiles_federation_lookup;
DROP INDEX IF EXISTS public.idx_profiles_federation_enabled;
DROP INDEX IF EXISTS public.idx_profiles_federated_id;
DROP INDEX IF EXISTS public.idx_profiles_domain;
DROP INDEX IF EXISTS public.idx_profiles_auth_user_id;
DROP INDEX IF EXISTS public.idx_posts_visibility;
DROP INDEX IF EXISTS public.idx_posts_timeline;
DROP INDEX IF EXISTS public.idx_posts_public_timeline;
DROP INDEX IF EXISTS public.idx_posts_public_created_at;
DROP INDEX IF EXISTS public.idx_posts_pinned;
DROP INDEX IF EXISTS public.idx_posts_local_public_created_at;
DROP INDEX IF EXISTS public.idx_posts_is_local;
DROP INDEX IF EXISTS public.idx_posts_is_deleted;
DROP INDEX IF EXISTS public.idx_posts_in_reply_to_conversation;
DROP INDEX IF EXISTS public.idx_posts_in_reply_to;
DROP INDEX IF EXISTS public.idx_posts_federation_visibility;
DROP INDEX IF EXISTS public.idx_posts_featured_engagement;
DROP INDEX IF EXISTS public.idx_posts_created_at;
DROP INDEX IF EXISTS public.idx_posts_conversation_root_id;
DROP INDEX IF EXISTS public.idx_posts_conversation_performance;
DROP INDEX IF EXISTS public.idx_posts_conversation_id;
DROP INDEX IF EXISTS public.idx_posts_author_id;
DROP INDEX IF EXISTS public.idx_posts_author_federation;
DROP INDEX IF EXISTS public.idx_posts_author_count;
DROP INDEX IF EXISTS public.idx_posts_ap_id;
DROP INDEX IF EXISTS public.idx_post_interactions_user_post_type;
DROP INDEX IF EXISTS public.idx_post_interactions_user_id;
DROP INDEX IF EXISTS public.idx_post_interactions_unique_non_emoji;
DROP INDEX IF EXISTS public.idx_post_interactions_unique_emoji_by_id;
DROP INDEX IF EXISTS public.idx_post_interactions_unique_emoji_by_content;
DROP INDEX IF EXISTS public.idx_post_interactions_type;
DROP INDEX IF EXISTS public.idx_post_interactions_post_id;
DROP INDEX IF EXISTS public.idx_post_interactions_non_emoji_unique;
DROP INDEX IF EXISTS public.idx_post_interactions_federation;
DROP INDEX IF EXISTS public.idx_post_interactions_emoji_unique;
DROP INDEX IF EXISTS public.idx_post_interactions_emoji_reactions;
DROP INDEX IF EXISTS public.idx_post_interactions_ap_id;
DROP INDEX IF EXISTS public.idx_post_hashtags_post_id;
DROP INDEX IF EXISTS public.idx_post_hashtags_hashtag_id;
DROP INDEX IF EXISTS public.idx_post_hashtags_created_at;
...
DROP INDEX IF EXISTS public.idx_notification_rate_limits_user_type;
DROP INDEX IF EXISTS public.idx_notification_preferences_user_id;
DROP INDEX IF EXISTS public.idx_notification_channels_user_id;
DROP INDEX IF EXISTS public.idx_notification_channels_unique;
DROP INDEX IF EXISTS public.idx_notification_channels_muted;
DROP INDEX IF EXISTS public.idx_notification_channels_composite;
DROP INDEX IF EXISTS public.idx_messages_user_conversation;
DROP INDEX IF EXISTS public.idx_messages_metadata_from_domain;
DROP INDEX IF EXISTS public.idx_messages_metadata_federated;
DROP INDEX IF EXISTS public.idx_messages_metadata_ap_id;
DROP INDEX IF EXISTS public.idx_hashtags_trending_score;
DROP INDEX IF EXISTS public.idx_hashtags_trending_rank;
DROP INDEX IF EXISTS public.idx_hashtags_normalized_tag;
DROP INDEX IF EXISTS public.idx_hashtags_last_used;
DROP INDEX IF EXISTS public.idx_hashtags_daily_uses;
DROP INDEX IF EXISTS public.idx_follows_unique;
DROP INDEX IF EXISTS public.idx_follows_status;
DROP INDEX IF EXISTS public.idx_follows_following_id;
DROP INDEX IF EXISTS public.idx_follows_following_count;
DROP INDEX IF EXISTS public.idx_follows_follower_id;
DROP INDEX IF EXISTS public.idx_follows_follower_count;
DROP INDEX IF EXISTS public.idx_follows_federation_status;
DROP INDEX IF EXISTS public.idx_follows_ap_id;
DROP INDEX IF EXISTS public.idx_federation_delivery_stats_period;
DROP INDEX IF EXISTS public.idx_federation_delivery_queue_next_attempt_pending;
DROP INDEX IF EXISTS public.idx_federated_instances_last_seen;
DROP INDEX IF EXISTS public.idx_federated_instances_is_blocked;
DROP INDEX IF EXISTS public.idx_federated_instances_domain;
DROP INDEX IF EXISTS public.idx_emojis_usage_count;
DROP INDEX IF EXISTS public.idx_emojis_updated_at;
DROP INDEX IF EXISTS public.idx_emojis_unique_federated_domain_name;
DROP INDEX IF EXISTS public.idx_emojis_server_id;
DROP INDEX IF EXISTS public.idx_emojis_name;
DROP INDEX IF EXISTS public.idx_emojis_last_used;
DROP INDEX IF EXISTS public.idx_emojis_domain_name;
DROP INDEX IF EXISTS public.idx_emoji_usage_user_id;
DROP INDEX IF EXISTS public.idx_emoji_usage_used_at;
DROP INDEX IF EXISTS public.idx_emoji_usage_server_id;
DROP INDEX IF EXISTS public.idx_emoji_usage_emoji_id;
DROP INDEX IF EXISTS public.idx_emoji_usage_context;
DROP INDEX IF EXISTS public.idx_delivery_queue_target_domain_new;
DROP INDEX IF EXISTS public.idx_delivery_queue_status_new;
DROP INDEX IF EXISTS public.idx_delivery_queue_next_attempt_new;
DROP INDEX IF EXISTS public.idx_delivery_queue_activity_id_new;
DROP INDEX IF EXISTS public.idx_conversations_updated_at;
DROP INDEX IF EXISTS public.idx_conversations_type_active;
...
DROP INDEX IF EXISTS public.idx_channels_server_order;
DROP INDEX IF EXISTS public.idx_channels_category_order;
DROP INDEX IF EXISTS public.idx_channels_ap_id;
DROP INDEX IF EXISTS public.idx_categories_server_order;
DROP INDEX IF EXISTS public.idx_background_job_queue;
DROP INDEX IF EXISTS public.idx_ap_object_cache_type;
DROP INDEX IF EXISTS public.idx_ap_object_cache_expires;
DROP INDEX IF EXISTS public.idx_ap_actor_cache_username;
DROP INDEX IF EXISTS public.idx_ap_actor_cache_expires;
DROP INDEX IF EXISTS public.idx_ap_actor_cache_domain;
DROP INDEX IF EXISTS public.idx_ap_activities_type_new;
DROP INDEX IF EXISTS public.idx_ap_activities_type;
DROP INDEX IF EXISTS public.idx_ap_activities_target_new;
DROP INDEX IF EXISTS public.idx_ap_activities_status_type;
DROP INDEX IF EXISTS public.idx_ap_activities_status_new;
DROP INDEX IF EXISTS public.idx_ap_activities_status;
DROP INDEX IF EXISTS public.idx_ap_activities_origin_domain;
DROP INDEX IF EXISTS public.idx_ap_activities_federation_status;
DROP INDEX IF EXISTS public.idx_ap_activities_created_at_new;
DROP INDEX IF EXISTS public.idx_ap_activities_created_at;
DROP INDEX IF EXISTS public.idx_ap_activities_ap_id_new;
DROP INDEX IF EXISTS public.idx_ap_activities_ap_id;
DROP INDEX IF EXISTS public.idx_ap_activities_actor_id_new;
DROP INDEX IF EXISTS public.idx_ap_activities_actor_id;
...
DROP INDEX IF EXISTS public.idx_activitypub_processing_stats_date;
DROP INDEX IF EXISTS public.idx_activity_processing_logs_activity_id;
...
ALTER TABLE IF EXISTS ONLY realtime.messages_2025_11_19 DROP CONSTRAINT IF EXISTS messages_2025_11_19_pkey;
ALTER TABLE IF EXISTS ONLY realtime.messages_2025_11_18 DROP CONSTRAINT IF EXISTS messages_2025_11_18_pkey;
ALTER TABLE IF EXISTS ONLY realtime.messages_2025_11_17 DROP CONSTRAINT IF EXISTS messages_2025_11_17_pkey;
...
ALTER TABLE IF EXISTS ONLY public.voice_federation_events DROP CONSTRAINT IF EXISTS voice_federation_events_pkey;
ALTER TABLE IF EXISTS ONLY public.user_timeline_cache DROP CONSTRAINT IF EXISTS user_timeline_cache_user_id_timeline_type_key;
ALTER TABLE IF EXISTS ONLY public.user_timeline_cache DROP CONSTRAINT IF EXISTS user_timeline_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.user_servers DROP CONSTRAINT IF EXISTS user_servers_user_id_server_id_unique;
ALTER TABLE IF EXISTS ONLY public.user_servers DROP CONSTRAINT IF EXISTS user_servers_pkey;
ALTER TABLE IF EXISTS ONLY public.user_private_keys DROP CONSTRAINT IF EXISTS user_private_keys_user_id_key;
ALTER TABLE IF EXISTS ONLY public.user_private_keys DROP CONSTRAINT IF EXISTS user_private_keys_pkey;
ALTER TABLE IF EXISTS ONLY public.user_mutes DROP CONSTRAINT IF EXISTS user_mutes_pkey;
ALTER TABLE IF EXISTS ONLY public.user_mutes DROP CONSTRAINT IF EXISTS user_mutes_muter_id_muted_user_id_key;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_pkey;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_blocker_id_blocked_user_id_key;
ALTER TABLE IF EXISTS ONLY public.unread_counts DROP CONSTRAINT IF EXISTS unread_counts_pkey;
ALTER TABLE IF EXISTS ONLY public.trending_users DROP CONSTRAINT IF EXISTS trending_users_user_id_period_type_period_start_key;
ALTER TABLE IF EXISTS ONLY public.trending_users DROP CONSTRAINT IF EXISTS trending_users_pkey;
ALTER TABLE IF EXISTS ONLY public.trending_posts DROP CONSTRAINT IF EXISTS trending_posts_post_id_period_type_period_start_key;
ALTER TABLE IF EXISTS ONLY public.trending_posts DROP CONSTRAINT IF EXISTS trending_posts_pkey;
ALTER TABLE IF EXISTS ONLY public.timeline_entries DROP CONSTRAINT IF EXISTS timeline_entries_pkey;
ALTER TABLE IF EXISTS ONLY public.servers DROP CONSTRAINT IF EXISTS servers_pkey;
ALTER TABLE IF EXISTS ONLY public.server_membership_events DROP CONSTRAINT IF EXISTS server_membership_events_pkey;
ALTER TABLE IF EXISTS ONLY public.server_federation_events DROP CONSTRAINT IF EXISTS server_federation_events_pkey;
ALTER TABLE IF EXISTS ONLY public.reactions DROP CONSTRAINT IF EXISTS reactions_pkey;
ALTER TABLE IF EXISTS ONLY public.reactions DROP CONSTRAINT IF EXISTS reactions_message_id_user_id_emoji_id_key;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_username_domain_key;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS posts_pkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS posts_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_pkey;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.post_hashtags DROP CONSTRAINT IF EXISTS post_hashtags_post_id_hashtag_id_key;
ALTER TABLE IF EXISTS ONLY public.post_hashtags DROP CONSTRAINT IF EXISTS post_hashtags_pkey;
ALTER TABLE IF EXISTS ONLY public.pg_background_job DROP CONSTRAINT IF EXISTS pg_background_job_pkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.notification_rate_limits DROP CONSTRAINT IF EXISTS notification_rate_limits_user_id_notification_type_source_u_key;
ALTER TABLE IF EXISTS ONLY public.notification_rate_limits DROP CONSTRAINT IF EXISTS notification_rate_limits_pkey;
...
ALTER TABLE IF EXISTS ONLY public.notification_channels DROP CONSTRAINT IF EXISTS notification_channels_pkey;
ALTER TABLE IF EXISTS ONLY public.messages DROP CONSTRAINT IF EXISTS messages_pkey;
ALTER TABLE IF EXISTS ONLY public.invites DROP CONSTRAINT IF EXISTS invites_pkey;
ALTER TABLE IF EXISTS ONLY public.instance_config DROP CONSTRAINT IF EXISTS instance_config_pkey;
ALTER TABLE IF EXISTS ONLY public.instance_config DROP CONSTRAINT IF EXISTS instance_config_config_key_key;
ALTER TABLE IF EXISTS ONLY public.emoji_usage DROP CONSTRAINT IF EXISTS idx_emoji_usage_unique;
ALTER TABLE IF EXISTS ONLY public.hashtags DROP CONSTRAINT IF EXISTS hashtags_pkey;
ALTER TABLE IF EXISTS ONLY public.hashtags DROP CONSTRAINT IF EXISTS hashtags_normalized_tag_key;
ALTER TABLE IF EXISTS ONLY public.hashtag_archive DROP CONSTRAINT IF EXISTS hashtag_archive_pkey;
ALTER TABLE IF EXISTS ONLY public.follows DROP CONSTRAINT IF EXISTS follows_pkey;
ALTER TABLE IF EXISTS ONLY public.follows DROP CONSTRAINT IF EXISTS follows_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.files DROP CONSTRAINT IF EXISTS files_pkey;
ALTER TABLE IF EXISTS ONLY public.federation_delivery_stats DROP CONSTRAINT IF EXISTS federation_delivery_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.federation_delivery_queue DROP CONSTRAINT IF EXISTS federation_delivery_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.federated_instances DROP CONSTRAINT IF EXISTS federated_instances_pkey;
ALTER TABLE IF EXISTS ONLY public.federated_instances DROP CONSTRAINT IF EXISTS federated_instances_domain_key;
ALTER TABLE IF EXISTS ONLY public.emojis DROP CONSTRAINT IF EXISTS emojis_pkey;
ALTER TABLE IF EXISTS ONLY public.emoji_usage DROP CONSTRAINT IF EXISTS emoji_usage_pkey;
ALTER TABLE IF EXISTS ONLY public.conversations DROP CONSTRAINT IF EXISTS conversations_pkey;
ALTER TABLE IF EXISTS ONLY public.conversation_participants DROP CONSTRAINT IF EXISTS conversation_participants_unique;
...
ALTER TABLE IF EXISTS ONLY public.channel_categories DROP CONSTRAINT IF EXISTS channel_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.blocked_instances DROP CONSTRAINT IF EXISTS blocked_instances_pkey;
ALTER TABLE IF EXISTS ONLY public.blocked_instances DROP CONSTRAINT IF EXISTS blocked_instances_domain_key;
ALTER TABLE IF EXISTS ONLY public.ap_object_cache DROP CONSTRAINT IF EXISTS ap_object_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.ap_object_cache DROP CONSTRAINT IF EXISTS ap_object_cache_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.ap_actor_cache DROP CONSTRAINT IF EXISTS ap_actor_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.ap_actor_cache DROP CONSTRAINT IF EXISTS ap_actor_cache_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.ap_activities DROP CONSTRAINT IF EXISTS ap_activities_pkey;
ALTER TABLE IF EXISTS ONLY public.ap_activities DROP CONSTRAINT IF EXISTS ap_activities_ap_id_key;
ALTER TABLE IF EXISTS ONLY public.admin_audit_log DROP CONSTRAINT IF EXISTS admin_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.activitypub_processing_stats DROP CONSTRAINT IF EXISTS activitypub_processing_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.activitypub_processing_stats DROP CONSTRAINT IF EXISTS activitypub_processing_stats_date_key;
ALTER TABLE IF EXISTS ONLY public.activity_processing_logs DROP CONSTRAINT IF EXISTS activity_processing_logs_pkey;
...
ALTER TABLE IF EXISTS public.activity_processing_logs ALTER COLUMN id DROP DEFAULT;
...
DROP TABLE IF EXISTS realtime.messages_2025_11_19;
DROP TABLE IF EXISTS realtime.messages_2025_11_18;
DROP TABLE IF EXISTS realtime.messages_2025_11_17;
...
DROP TABLE IF EXISTS public.voice_federation_events;
DROP TABLE IF EXISTS public.user_timeline_cache;
DROP TABLE IF EXISTS public.user_servers;
DROP TABLE IF EXISTS public.user_private_keys;
DROP TABLE IF EXISTS public.user_mutes;
DROP TABLE IF EXISTS public.user_blocks;
DROP TABLE IF EXISTS public.unread_counts;
DROP TABLE IF EXISTS public.trending_users;
DROP TABLE IF EXISTS public.trending_refresh_queue;
DROP TABLE IF EXISTS public.trending_posts;
DROP VIEW IF EXISTS public.timeline_posts;
DROP TABLE IF EXISTS public.timeline_entries;
DROP TABLE IF EXISTS public.servers;
DROP TABLE IF EXISTS public.server_membership_events;
DROP TABLE IF EXISTS public.server_federation_events;
DROP TABLE IF EXISTS public.schedule_result;
DROP TABLE IF EXISTS public.reactions;
DROP TABLE IF EXISTS public.post_interactions;
DROP TABLE IF EXISTS public.post_hashtags;
DROP TABLE IF EXISTS public.pg_background_job;
...
DROP VIEW IF EXISTS public.instance_health;
...
DROP VIEW IF EXISTS public.follow_relationships;
DROP TABLE IF EXISTS public.profiles;
DROP TABLE IF EXISTS public.follows;
DROP TABLE IF EXISTS public.files;
DROP VIEW IF EXISTS public.federation_stats;
DROP TABLE IF EXISTS public.federation_delivery_stats;
DROP TABLE IF EXISTS public.federation_delivery_queue;
DROP TABLE IF EXISTS public.federated_instances;
DROP TABLE IF EXISTS public.emojis;
DROP TABLE IF EXISTS public.emoji_usage;
...
DROP TABLE IF EXISTS public.channel_categories;
DROP TABLE IF EXISTS public.blocked_instances;
DROP TABLE IF EXISTS public.ap_object_cache;
DROP TABLE IF EXISTS public.ap_actor_cache;
DROP TABLE IF EXISTS public.ap_activities;
DROP TABLE IF EXISTS public.admin_audit_log;
DROP TABLE IF EXISTS public.activitypub_processing_stats;
DROP SEQUENCE IF EXISTS public.activity_processing_logs_id_seq;
DROP TABLE IF EXISTS public.activity_processing_logs;
...
DROP FUNCTION IF EXISTS public.upsert_ap_activity(p_ap_id text, p_ap_type text, p_actor_ap_id text, p_activity_data jsonb, p_origin_domain text, p_to_addresses text[], p_cc_addresses text[], p_bto_addresses text[], p_bcc_addresses text[], p_is_local boolean);
DROP FUNCTION IF EXISTS public.update_updated_at_column();
DROP FUNCTION IF EXISTS public.update_reply_counts();
DROP FUNCTION IF EXISTS public.update_post_counters();
DROP FUNCTION IF EXISTS public.update_group_name(conversation_uuid uuid, user_profile_id uuid, new_name text);
DROP FUNCTION IF EXISTS public.update_group_icon(conversation_uuid uuid, user_profile_id uuid, icon_path text);
...
DROP FUNCTION IF EXISTS public.set_member_instance();
DROP FUNCTION IF EXISTS public.set_instance_config(p_admin_id uuid, p_key text, p_value jsonb, p_description text);
DROP FUNCTION IF EXISTS public.server_has_remote_members(p_server_id uuid);
DROP FUNCTION IF EXISTS public.send_notification_to_user(notification_type character varying, to_user_id uuid, notification_data jsonb, server_id uuid, channel_id uuid, conversation_id uuid, from_user_id uuid, priority character varying);
...
DROP FUNCTION IF EXISTS public.send_notification(notification_type character varying, to_user_ids uuid[], notification_data jsonb, server_id uuid, channel_id uuid, conversation_id uuid, from_user_id uuid, priority character varying);
...
DROP FUNCTION IF EXISTS public.search_federated_users(p_query text, p_limit integer);
DROP FUNCTION IF EXISTS public.run_trending_maintenance();
DROP FUNCTION IF EXISTS public.route_server_membership();
DROP FUNCTION IF EXISTS public.route_server_leave();
DROP FUNCTION IF EXISTS public.route_channel_message();
...
DROP FUNCTION IF EXISTS public.remove_timeline_on_unfollow();
DROP FUNCTION IF EXISTS public.remove_post_emoji_reaction(p_user_id uuid, p_post_id uuid, p_emoji_id uuid, p_custom_emoji_content text);
DROP FUNCTION IF EXISTS public.remove_group_icon(conversation_uuid uuid, user_profile_id uuid);
DROP FUNCTION IF EXISTS public.record_emoji_usage(p_emoji_id uuid, p_user_id uuid, p_server_id uuid, p_context_type text, p_context_id uuid);
...
DROP FUNCTION IF EXISTS public.process_post_hashtags(p_post_id uuid, p_content jsonb);
...
DROP FUNCTION IF EXISTS public.moderate_user(p_admin_id uuid, p_target_user_id uuid, p_action text, p_reason text);
DROP FUNCTION IF EXISTS public.mark_notifications_read(p_user_id uuid, p_notification_ids uuid[]);
DROP FUNCTION IF EXISTS public.log_admin_action(p_admin_id uuid, p_action_type text, p_target_type text, p_target_id text, p_action_details jsonb, p_ip_address inet, p_user_agent text);
...
DROP FUNCTION IF EXISTS public.is_federation_enabled_for_user(user_id uuid);
...
DROP FUNCTION IF EXISTS public.handle_unified_notification_processing();
DROP FUNCTION IF EXISTS public.handle_unified_interaction_federation();
...
DROP FUNCTION IF EXISTS public.handle_post_interaction_federation();
DROP FUNCTION IF EXISTS public.handle_outgoing_messages();
DROP FUNCTION IF EXISTS public.handle_message_federation();
DROP FUNCTION IF EXISTS public.handle_local_post_mention_notifications();
...
DROP FUNCTION IF EXISTS public.get_user_notifications(p_user_id uuid, p_limit integer, p_offset integer, p_unread_only boolean, p_notification_types character varying[]);
DROP FUNCTION IF EXISTS public.get_user_id_from_username(username_param text);
DROP FUNCTION IF EXISTS public.get_user_handle(p_user_id uuid);
...
DROP FUNCTION IF EXISTS public.get_trending_hashtags(p_days integer, p_limit integer);
DROP FUNCTION IF EXISTS public.get_timeline(p_user_id uuid, p_limit integer, p_before timestamp without time zone);
...
DROP FUNCTION IF EXISTS public.get_public_federation_settings();
DROP FUNCTION IF EXISTS public.get_post_with_context(p_post_id uuid, p_user_id uuid, p_context_type text, p_highlight_reply uuid, p_max_depth integer, p_include_interactions boolean);
DROP FUNCTION IF EXISTS public.get_post_emoji_reactions(p_post_id uuid, p_user_limit integer);
DROP FUNCTION IF EXISTS public.get_or_create_dm_conversation(p_user1_id uuid, p_user2_id uuid);
DROP FUNCTION IF EXISTS public.get_or_create_conversation(user1_uuid uuid, user2_uuid uuid);
DROP FUNCTION IF EXISTS public.get_message_reactions(message_id uuid);
DROP FUNCTION IF EXISTS public.get_instance_domain();
...
DROP FUNCTION IF EXISTS public.get_enhanced_timeline_posts(p_user_id uuid, p_timeline_type text, p_limit integer, p_max_id text);
DROP FUNCTION IF EXISTS public.get_emoji_metadata_bulk(server_ids uuid[]);
DROP FUNCTION IF EXISTS public.get_default_channel(p_server_id uuid);
DROP FUNCTION IF EXISTS public.get_conversation_thread(p_conversation_id text, p_user_id uuid);
DROP FUNCTION IF EXISTS public.get_conversation_participants(conversation_uuid uuid);
DROP FUNCTION IF EXISTS public.get_conversation_context(in_post_id uuid, in_user_id uuid);
DROP FUNCTION IF EXISTS public.get_batch_post_reactions(post_ids uuid[]);
DROP FUNCTION IF EXISTS public.get_batch_post_emoji_reactions(p_post_ids uuid[], p_user_limit integer);
DROP FUNCTION IF EXISTS public.get_batch_message_reactions(message_ids uuid[]);
DROP FUNCTION IF EXISTS public.extract_mentions(content jsonb);
DROP FUNCTION IF EXISTS public.extract_hashtags_from_content(p_content jsonb);
...
DROP FUNCTION IF EXISTS public.determine_message_federation_type(p_message_id uuid);
DROP FUNCTION IF EXISTS public.delete_server_with_cleanup(p_server_id uuid, p_owner_id uuid);
DROP FUNCTION IF EXISTS public.create_system_message(p_channel_id uuid, p_message_type text, p_data jsonb);
DROP FUNCTION IF EXISTS public.create_or_get_multi_conversation(participant_ids uuid[], conversation_type text, conversation_name text, created_by_id uuid);
DROP FUNCTION IF EXISTS public.create_or_get_direct_conversation(user1_uuid uuid, user2_uuid uuid);
DROP FUNCTION IF EXISTS public.create_notification_with_spam_prevention(p_user_id uuid, p_type text, p_source_user_id uuid, p_title text, p_message text, p_data jsonb, p_server_id uuid, p_channel_id uuid, p_conversation_id uuid);
DROP FUNCTION IF EXISTS public.create_notification_structured(p_user_id uuid, p_type character varying, p_data jsonb);
DROP FUNCTION IF EXISTS public.create_notification_preferences();
DROP FUNCTION IF EXISTS public.create_group_conversation(creator_user_id uuid, conversation_name text, participant_ids uuid[], initial_metadata jsonb);
DROP FUNCTION IF EXISTS public.create_group_conversation(creator_user_id uuid, participant_user_ids uuid[], conversation_name text, is_private boolean);
DROP FUNCTION IF EXISTS public.create_default_server_structure(p_server_id uuid);
DROP FUNCTION IF EXISTS public.create_default_notification_preferences(p_user_id uuid);
DROP FUNCTION IF EXISTS public.create_comprehensive_timeline_entries();
DROP FUNCTION IF EXISTS public.create_activitypub_note_activity(post_id uuid);
DROP FUNCTION IF EXISTS public.convert_jsonb_to_ap(content jsonb);
DROP FUNCTION IF EXISTS public.convert_ap_to_jsonb(html_content text, tags jsonb);
DROP FUNCTION IF EXISTS public.cleanup_old_trending_data();
...
DROP FUNCTION IF EXISTS public.check_message_emoji_reaction_limit();
DROP FUNCTION IF EXISTS public.check_emoji_reaction_limit();
DROP FUNCTION IF EXISTS public.can_manage_group_icon(conversation_uuid uuid, user_profile_id uuid);
...
DROP FUNCTION IF EXISTS public.backfill_timeline_on_follow();
DROP FUNCTION IF EXISTS public.backfill_timeline_entries();
DROP FUNCTION IF EXISTS public.add_user_to_conversation(conversation_uuid uuid, user_uuid uuid, user_role text);
DROP FUNCTION IF EXISTS public.add_post_emoji_reaction(p_user_id uuid, p_post_id uuid, p_emoji_id uuid, p_custom_emoji_content text);
DROP FUNCTION IF EXISTS public.add_existing_posts_to_new_follower_timeline();
