-- Critical Bug Fixes for DM/Federation System (CORRECTED)
-- Apply BEFORE running migration 091
-- Fixes: function signatures, table references, casting, typos
-- ONLY send notifications to LOCAL users!

BEGIN;

-- =====================================================
-- FIX 1: handle_message_federation() function  
-- Issues: send_notification_to_user signature, "derated" typo, remote user notifications
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '   - ✅ ONLY notify LOCAL users (p.is_local = true)';
    RAISE NOTICE '   - ❌ NO notifications to remote users!';
