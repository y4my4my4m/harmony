-- =============================================
-- ACTIVITYPUB NOTIFICATION TRIGGERS MIGRATION (CORRECTED)
-- =============================================
-- This migration adds comprehensive notification triggers for ActivityPub interactions
-- Fixed to match the actual notifications table schema (data field only)

-- =============================================
-- HELPER FUNCTIONS
-- =============================================

-- Function to create structured ActivityPub notifications (corrected for actual schema)
...
BEGIN
    ...
    -- Combine title, message, and original data into final data object
    ...
    -- Insert notification using actual schema (no title/message columns)
...
COMMENT ON FUNCTION create_activitypub_notification(UUID, VARCHAR, JSONB, INTEGER) IS 'Creates standardized ActivityPub notifications using data field only (matches actual schema)';
