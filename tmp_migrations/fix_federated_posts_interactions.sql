-- Fix timeline_posts view to remove non-existent interaction columns
-- These should only be calculated in get_timeline_posts_with_interactions function
...
-- Recreate the RPC function with proper return structure
